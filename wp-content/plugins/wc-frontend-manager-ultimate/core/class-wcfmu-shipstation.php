...
class WCFMu_Shipstation
{
    ...
    public function __construct()
    {
        ...
        add_action( 'wcfm_init', [$this, 'maybe_reinitialize_marketplace'], 13 );
    ...
    /**
     * Re-initialize marketplace class if not initialized already
     *
     * @return void
     */
    public function maybe_reinitialize_marketplace(): void {
        global $WCFM, $WCFMu;
        ...
        if (!$WCFM->wcfm_marketplace) {
            ...
            if (!function_exists('shipstation_vendor_id_from_auth_key')) {
            ...
            $WCFM->load_class($WCFM->is_marketplace);
