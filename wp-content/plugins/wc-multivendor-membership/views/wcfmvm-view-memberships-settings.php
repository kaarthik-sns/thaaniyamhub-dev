...
$stripe_webhook_secret_live = isset( $membership_payment_settings['stripe_webhook_secret_live'] ) ? $membership_payment_settings['stripe_webhook_secret_live'] : '';
$stripe_webhook_secret_test = isset( $membership_payment_settings['stripe_webhook_secret_test'] ) ? $membership_payment_settings['stripe_webhook_secret_test'] : '';
$stripe_webhook_endpoint    = add_query_arg( 'wcfmvm_process_ipn', 'stripe_webhook', get_wcfm_membership_url() );
/* translators: %s: the site's Stripe webhook endpoint URL */
$stripe_webhook_hint        = sprintf( __( 'Add a webhook endpoint for %s in your Stripe dashboard, subscribe it to checkout.session.completed, invoice.payment_succeeded, invoice.payment_failed and customer.subscription.deleted, then paste its signing secret (whsec_...) here. Required for automatic subscription renewals.', 'wc-multivendor-membership' ), $stripe_webhook_endpoint );
						...
						<div id="membership_settings_form_payment_expander" class="wcfm-content">
							<?php
								$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'membership_setting_payment_fields', array(  
																																						...
																																						'stripe_webhook_secret_live' => array( 'label' => __( 'Stripe Live Webhook Signing Secret', 'wc-multivendor-membership' ), 'name' => 'membership_payment_settings[stripe_webhook_secret_live]', 'type' => 'password', 'class' => 'wcfm-text wcfm_ele payment_fields stripe_payment_field live_payment_field', 'label_class' => 'wcfm_title payment_fields stripe_payment_field live_payment_field', 'value' => $stripe_webhook_secret_live, 'hints' => $stripe_webhook_hint ),
																																						'stripe_webhook_secret_test' => array( 'label' => __( 'Stripe Test Webhook Signing Secret', 'wc-multivendor-membership' ), 'name' => 'membership_payment_settings[stripe_webhook_secret_test]', 'type' => 'password', 'class' => 'wcfm-text wcfm_ele payment_fields stripe_payment_field test_payment_field', 'label_class' => 'wcfm_title payment_fields stripe_payment_field test_payment_field', 'value' => $stripe_webhook_secret_test, 'hints' => $stripe_webhook_hint ),
