	...
	function wcfm_customfield_settings() {
		...
		$product_types              = apply_filters(
			...
			array(
				...
				'virtual'  => __( 'Virtual Product', 'wc-frontend-manager' ),
		...
		$field_types                = apply_filters(
			...
			array(
				...
				'checkbox'   => 'Check Box',
				'select'     => 'Select',
				'mselect'    => 'Multi-Select Drop Down',
				'upload'     => 'File/Image',
				'html'       => 'HTML',
			)
		);
			...
			<div id="wcfm_settings_form_custom_field_expander" class="wcfm-content">
				...
				<?php
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_settings_fields_custom_field',
							array(
								'wcfm_product_custom_fields' => array(
									'label'       => __( 'Custom Fields', 'wc-frontend-manager' ),
									'type'        => 'multiinput',
									'class'       => 'wcfm-text wcfm_ele',
									'label_class' => 'wcfm_title',
									'desc_class'  => 'instructions',
									'value'       => $wcfm_product_custom_fields,
									'desc'        => __( 'You can integrate any Third Party plugin using Custom Fields, but you should use the same fields name as used by Third Party plugins.', 'wc-frontend-manager' ),
									'options'     => array(
										'enable'     => array(
										...
										'block_name' => array(
											'label'       => __( 'Block Name', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
										),
										'exclude_product_types' => array(
											'label'       => __( 'Exlude Product Types', 'wc-frontend-manager' ),
											'type'        => 'select',
											...
											'class'       => 'wcfm-select wcfm-select2 wcfm_ele exclude_product_types',
											'label_class' => 'wcfm_title',
											'hints'       => __( 'Choose product types for which you want to disable this field block.', 'wc-frontend-manager' ),
										),
										'visibility' => array(
											'label'       => __( 'Visibility', 'wc-frontend-manager' ),
											'type'        => 'select',
											'options'     => $visibility_options,
											'class'       => 'wcfm-select wcfm_ele visibility_options',
											'label_class' => 'wcfm_title',
											'hints'       => __( 'Set where and how you want to visible this custom field block in single product page.', 'wc-frontend-manager' ),
										),
										'is_group'   => array(
											'label'       => __( 'Fields as Group?', 'wc-frontend-manager' ),
											'type'        => 'checkbox',
											'value'       => 'yes',
											'class'       => 'wcfm-checkbox wcfm_ele custom_field_is_group',
											'label_class' => 'wcfm_title checkbox_title',
										),
										'group_name' => array(
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele custom_field_is_group_name',
											'placeholder' => __( 'Group name', 'wc-frontend-manager' ),
											'label_class' => 'wcfm_title',
										),
										'wcfm_product_custom_block_fields' => array(
											'label'       => __( 'Fields', 'wc-frontend-manager' ) . '<span class="fields_collapser wcfmfa fa-arrow-circle-down"></span>',
											'type'        => 'multiinput',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'options'     => array(
												...
												'name'     => array(
													...
													'label_class' => 'wcfm_title',
													'hints' => __( 'This is will going to use as `meta_key` for storing this field value in database.', 'wc-frontend-manager' ),
												),
												'options'  => array(
													'label' => __( 'Options', 'wc-frontend-manager' ),
													'type' => 'textarea',
													'class' => 'wcfm-textarea wcfm_ele field_type_select_options',
													'label_class' => 'wcfm_title field_type_select_options',
													'placeholder' => __( 'Insert option values | separated, leave first element empty to show as \'-Select-\'', 'wc-frontend-manager' ),
												),
												'content'  => array(
													'label' => __( 'Content', 'wc-frontend-manager' ),
													'type' => 'textarea',
													'class' => 'wcfm-textarea wcfm_ele field_type_html_options',
													'label_class' => 'wcfm_title field_type_html_options',
												),
												'help_text' => array(
