...
class WCFM_WCSubscriptions {
	...
	function wcfmcap_product_types( $product_types, $handler = 'wcfm_capability_options', $wcfm_capability_options = array() ) {
		...
		$product_types['variable-subscription'] = array(
			'label'       => __( 'Variable Subscriptions', 'wc-frontend-manager' ),
			'name'        => $handler . '[variable-subscription]',
			'type'        => 'checkboxoffon',
			'class'       => 'wcfm-checkbox wcfm_ele',
			'value'       => 'yes',
			'label_class' => 'wcfm_title checkbox_title',
			'dfvalue'     => $variable_subscription,
		);
		...
		$general_fields = array_slice( $general_fields, 0, 3, true ) +
																	array(
																		'_subscription_price' => array(
																			...
																			'type'        => 'text',
																			'class'       => 'wcfm-text wcfm_ele wcfm_ele_hide subscription_price_ele subscription',
																			'label_class' => 'wcfm_title wcfm_ele wcfm_ele_hide subscription',
																		...
																		'_subscription_period_interval' => array(
																			...
																			'class'       => 'wcfm-select wcfm_ele wcfm_ele_hide subscription_price_ele subscription',
																			'label_class' => 'wcfm_title wcfm_ele wcfm_ele_hide subscription',
																		...
																		'_subscription_length_day' => array(
																			...
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele wcfm_ele_hide subscription_length_day subscription',
																			'label_class' => 'wcfm_title wcfm_ele wcfm_ele_hide subscription_length_ele subscription_length_day subscription',
																		...
																		'_subscription_length_week' => array(
																			...
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele wcfm_ele_hide subscription_length_week subscription',
																			'label_class' => 'wcfm_title wcfm_ele wcfm_ele_hide subscription_length_ele subscription_length_week subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'woocommerce-subscriptions' ),
																			'value'       => $subscription_length,
																		),
																		'_subscription_length_month' => array(
																			...
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele wcfm_ele_hide subscription_length_month subscription',
																			'label_class' => 'wcfm_title wcfm_ele wcfm_ele_hide subscription_length_ele subscription_length_month subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'woocommerce-subscriptions' ),
																			'value'       => $subscription_length,
																		),
																		'_subscription_length_year' => array(
																			...
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele wcfm_ele_hide subscription_length_year subscription',
																			'label_class' => 'wcfm_title wcfm_ele wcfm_ele_hide subscription_length_ele subscription_length_year subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'woocommerce-subscriptions' ),
																			'value'       => $subscription_length,
																		),
																	) +
