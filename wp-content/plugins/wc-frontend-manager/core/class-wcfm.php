...
class WCFM {
	...
	function init() {
		...
		} elseif ( get_option( 'wcfm_updated_end_point_wc_bookings' ) ) {
	...
	function get_wcfm_modules() {
		$wcfm_modules = array(
			...
			'enquiry_tab'    => array(
				'label' => __( 'Enquiry Tab', 'wc-frontend-manager' ),
				'hints' => __( 'If you just want to hide Single Product page `Enquiry Tab`, but keep enable `Enquiry Module` for `Catalog Mode`.', 'wc-frontend-manager' ),
			),
			'catalog'        => array(
				'label' => __( 'Catalog Mode', 'wc-frontend-manager' ),
				'hints' => __( 'If you disable `Enquiry Module` then `Catalog Module` will stop working automatically.', 'wc-frontend-manager' ),
			),
