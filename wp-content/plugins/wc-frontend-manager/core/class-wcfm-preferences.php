...
class WCFM_Preferences {
	...
	public function __construct() {
		...
		add_filter( 'wcfm_is_pref_multi_store', array( &$this, 'wcfmpref_multi_store' ), 750 );
	}
