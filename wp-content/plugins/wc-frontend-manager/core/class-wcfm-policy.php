...
class WCFM_Policy {
	...
	function wcfm_policy_settings( $wcfm_options ) {
		...
		if ( ! apply_filters( 'wcfm_is_allow_policy_settings', true ) ) {
			return;
		}
		...
		if ( $is_marketplace && ( $is_marketplace == 'wcmarketplace' ) ) {
			...
			if ( wcfm_empty( $_wcfm_shipping_policy ) ) {
				$_wcfm_shipping_policy = $_wcmp_shipping_policy;
			}
			$_wcmp_refund_policy = isset( $wcmp_policy_settings['refund_policy'] ) ? $wcmp_policy_settings['refund_policy'] : '';
			if ( wcfm_empty( $_wcfm_refund_policy ) ) {
				$_wcfm_refund_policy = $_wcmp_refund_policy;
			}
			$_wcmp_cancellation_policy = isset( $wcmp_policy_settings['cancellation_policy'] ) ? $wcmp_policy_settings['cancellation_policy'] : '';
			if ( wcfm_empty( $_wcfm_cancellation_policy ) ) {
				$_wcfm_cancellation_policy = $_wcmp_cancellation_policy;
			}
		}
					...
					apply_filters(
						...
						array(
							'wcfm_policy_tab_title'    => array(
								...
								'value'       => $_wcfm_policy_tab_title,
							),
							'wcfm_shipping_policy'     => array(
								'label'       => __( 'Shipping Policy', 'wc-frontend-manager' ),
								'type'        => $wpeditor,
								'class'       => 'wcfm-textarea wcfm_ele wcfm_custom_field_editor ' . $rich_editor,
								'label_class' => 'wcfm_title',
								'value'       => $_wcfm_shipping_policy,
							),
							...
							'wcfm_cancellation_policy' => array(
								...
								'value'       => $_wcfm_cancellation_policy,
							),
						)
					)
				);
	...
	function wcfm_policy_vendor_settings( $vendor_id ) {
		...
		if ( ! apply_filters( 'wcmp_vendor_can_overwrite_policies', true ) || ! apply_filters( 'wcfm_is_allow_policy_settings', true ) ) {
			return;
		}
		...
		if ( $is_marketplace && ( $is_marketplace == 'wcmarketplace' ) ) {
			...
			if ( wcfm_empty( $_wcfm_vendor_policy_tab_title ) ) {
				$_wcfm_vendor_policy_tab_title = $vendor_policy_tab_title;
			}
			$vendor_shipping_policy = get_user_meta( $vendor_id, '_vendor_shipping_policy', true );
			if ( wcfm_empty( $_wcfm_vendor_shipping_policy ) ) {
				$_wcfm_vendor_shipping_policy = $vendor_shipping_policy;
			}
			$vendor_refund_policy = get_user_meta( $vendor_id, '_vendor_refund_policy', true );
			if ( wcfm_empty( $_wcfm_vendor_refund_policy ) ) {
				$_wcfm_vendor_refund_policy = $vendor_refund_policy;
			}
			$vendor_cancellation_policy = get_user_meta( $vendor_id, '_vendor_cancellation_policy', true );
			if ( wcfm_empty( $_wcfm_vendor_cancellation_policy ) ) {
				$_wcfm_vendor_cancellation_policy = $vendor_cancellation_policy;
			}
		...
		$_wcfm_policy_tab_title = isset( $wcfm_policy_options['policy_tab_title'] ) ? $wcfm_policy_options['policy_tab_title'] : '';
		if ( wcfm_empty( $_wcfm_vendor_policy_tab_title ) ) {
			$_wcfm_vendor_policy_tab_title = $_wcfm_policy_tab_title;
		}
		$_wcfm_shipping_policy = isset( $wcfm_policy_options['shipping_policy'] ) ? $wcfm_policy_options['shipping_policy'] : '';
		if ( wcfm_empty( $_wcfm_vendor_shipping_policy ) ) {
			$_wcfm_vendor_shipping_policy = $_wcfm_shipping_policy;
		}
		$_wcfm_refund_policy = isset( $wcfm_policy_options['refund_policy'] ) ? $wcfm_policy_options['refund_policy'] : '';
		if ( wcfm_empty( $_wcfm_vendor_refund_policy ) ) {
			$_wcfm_vendor_refund_policy = $_wcfm_refund_policy;
		}
		$_wcfm_cancellation_policy = isset( $wcfm_policy_options['cancellation_policy'] ) ? $wcfm_policy_options['cancellation_policy'] : '';
		if ( wcfm_empty( $_wcfm_vendor_cancellation_policy ) ) {
			$_wcfm_vendor_cancellation_policy = $_wcfm_cancellation_policy;
		}
		...
		if ( $is_marketplace && ( $is_marketplace == 'wcmarketplace' ) ) {
			...
			$_wcmp_shipping_policy = isset( $wcmp_policy_settings['shipping_policy'] ) ? $wcmp_policy_settings['shipping_policy'] : '';
			if ( wcfm_empty( $_wcfm_vendor_shipping_policy ) ) {
				$_wcfm_vendor_shipping_policy = $_wcmp_shipping_policy;
			}
			$_wcmp_refund_policy = isset( $wcmp_policy_settings['refund_policy'] ) ? $wcmp_policy_settings['refund_policy'] : '';
			if ( wcfm_empty( $_wcfm_vendor_refund_policy ) ) {
				$_wcfm_vendor_refund_policy = $_wcmp_refund_policy;
			}
			$_wcmp_cancellation_policy = isset( $wcmp_policy_settings['cancellation_policy'] ) ? $wcmp_policy_settings['cancellation_policy'] : '';
			if ( wcfm_empty( $_wcfm_vendor_cancellation_policy ) ) {
				$_wcfm_vendor_cancellation_policy = $_wcmp_cancellation_policy;
			}
		}
					...
					apply_filters(
						...
						array(
							'wcfm_policy_tab_title'    => array(
								...
								'class'       => 'wcfm-text wcfm_ele',
								'label_class' => 'wcfm_title wcfm_ele',
								'value'       => $_wcfm_vendor_policy_tab_title,
							),
							'wcfm_shipping_policy'     => array(
								'label'       => __( 'Shipping Policy', 'wc-frontend-manager' ),
								'type'        => $wpeditor,
								'class'       => 'wcfm-textarea wcfm_ele wcfm_full_ele wcfm_custom_field_editor ' . $rich_editor,
								'label_class' => 'wcfm_title wcfm_full_title',
								'value'       => $_wcfm_vendor_shipping_policy,
							),
							'wcfm_refund_policy'       => array(
								'label'       => __( 'Refund Policy', 'wc-frontend-manager' ),
								'type'        => $wpeditor,
								'class'       => 'wcfm-textarea wcfm_ele wcfm_full_ele wcfm_custom_field_editor ' . $rich_editor,
								'label_class' => 'wcfm_title wcfm_full_title',
								'value'       => $_wcfm_vendor_refund_policy,
							),
							'wcfm_cancellation_policy' => array(
								'label'       => __( 'Cancellation/Return/Exchange Policy', 'wc-frontend-manager' ),
								'type'        => $wpeditor,
								'class'       => 'wcfm-textarea wcfm_ele wcfm_full_ele wcfm_custom_field_editor ' . $rich_editor,
								'label_class' => 'wcfm_title wcfm_full_title',
								'value'       => $_wcfm_vendor_cancellation_policy,
							),
						),
						$vendor_id
					)
	...
	function wcfm_policy_product_settings( $product_id, $product_type = '', $wcfm_is_translated_product = false, $wcfm_wpml_edit_disable_element = '' ) {
		...
		if ( ! apply_filters( 'wcfm_is_allow_policy_settings', true ) || ! apply_filters( 'wcfm_is_allow_policy_product_settings', true ) || ! apply_filters( 'wcfm_is_allow_product_policies', true ) ) {
			return;
		}

		if ( wcfm_is_vendor() && ! apply_filters( 'wcmp_vendor_can_overwrite_policies', true ) ) {
			return;
		}
		...
		if ( $product_id ) {
			...
			if ( $is_marketplace && ( $is_marketplace == 'wcmarketplace' ) ) {
				...
				if ( wcfm_empty( $_wcfm_product_shipping_policy ) ) {
					$_wcfm_product_shipping_policy = $_wcmp_shipping_policy;
				}
				$_wcmp_refund_policy = get_post_meta( $product_id, '_wcmp_refund_policy', true );
				if ( wcfm_empty( $_wcfm_product_refund_policy ) ) {
					$_wcfm_product_refund_policy = $_wcmp_refund_policy;
				}
				$_wcmp_cancellation_policy = get_post_meta( $product_id, '_wcmp_cancellation_policy', true );
				if ( wcfm_empty( $_wcfm_product_cancellation_policy ) ) {
					$_wcfm_product_cancellation_policy = $_wcmp_cancellation_policy;
				}
			}
		}
		...
		if ( $is_marketplace && wcfm_is_vendor() ) {
			...
			$_wcfm_vendor_policy_tab_title = isset( $wcfm_policy_vendor_options['policy_tab_title'] ) ? $wcfm_policy_vendor_options['policy_tab_title'] : '';
			if ( wcfm_empty( $_wcfm_product_policy_tab_title ) ) {
				$_wcfm_product_policy_tab_title = $_wcfm_vendor_policy_tab_title;
			}
			$_wcfm_vendor_shipping_policy = isset( $wcfm_policy_vendor_options['shipping_policy'] ) ? $wcfm_policy_vendor_options['shipping_policy'] : '';
			if ( wcfm_empty( $_wcfm_product_shipping_policy ) ) {
				$_wcfm_product_shipping_policy = $_wcfm_vendor_shipping_policy;
			}
			$_wcfm_vendor_refund_policy = isset( $wcfm_policy_vendor_options['refund_policy'] ) ? $wcfm_policy_vendor_options['refund_policy'] : '';
			if ( wcfm_empty( $_wcfm_product_refund_policy ) ) {
				$_wcfm_product_refund_policy = $_wcfm_vendor_refund_policy;
			}
			$_wcfm_vendor_cancellation_policy = isset( $wcfm_policy_vendor_options['cancellation_policy'] ) ? $wcfm_policy_vendor_options['cancellation_policy'] : '';
			if ( wcfm_empty( $_wcfm_product_cancellation_policy ) ) {
				$_wcfm_product_cancellation_policy = $_wcfm_vendor_cancellation_policy;
			}

			if ( $is_marketplace == 'wcmarketplace' ) {
				$vendor_policy_tab_title = get_user_meta( $vendor_id, '_vendor_policy_tab_title', true );
				if ( wcfm_empty( $_wcfm_product_policy_tab_title ) ) {
					$_wcfm_product_policy_tab_title = $vendor_policy_tab_title;
				}
				$vendor_shipping_policy = get_user_meta( $vendor_id, '_vendor_shipping_policy', true );
				if ( wcfm_empty( $_wcfm_product_shipping_policy ) ) {
					$_wcfm_product_shipping_policy = $vendor_shipping_policy;
				}
				$vendor_refund_policy = get_user_meta( $vendor_id, '_vendor_refund_policy', true );
				if ( wcfm_empty( $_wcfm_product_refund_policy ) ) {
					$_wcfm_product_refund_policy = $vendor_refund_policy;
				}
				$vendor_cancellation_policy = get_user_meta( $vendor_id, '_vendor_cancellation_policy', true );
				if ( wcfm_empty( $_wcfm_product_cancellation_policy ) ) {
					$_wcfm_product_cancellation_policy = $vendor_cancellation_policy;
				}
		...
		$_wcfm_policy_tab_title = isset( $wcfm_policy_options['policy_tab_title'] ) ? $wcfm_policy_options['policy_tab_title'] : '';
		if ( wcfm_empty( $_wcfm_product_policy_tab_title ) ) {
			$_wcfm_product_policy_tab_title = $_wcfm_policy_tab_title;
		}
		$_wcfm_shipping_policy = isset( $wcfm_policy_options['shipping_policy'] ) ? $wcfm_policy_options['shipping_policy'] : '';
		if ( wcfm_empty( $_wcfm_product_shipping_policy ) ) {
			$_wcfm_product_shipping_policy = $_wcfm_shipping_policy;
		}
		$_wcfm_refund_policy = isset( $wcfm_policy_options['refund_policy'] ) ? $wcfm_policy_options['refund_policy'] : '';
		if ( wcfm_empty( $_wcfm_product_refund_policy ) ) {
			$_wcfm_product_refund_policy = $_wcfm_refund_policy;
		}
		$_wcfm_cancellation_policy = isset( $wcfm_policy_options['cancellation_policy'] ) ? $wcfm_policy_options['cancellation_policy'] : '';
		if ( wcfm_empty( $_wcfm_product_cancellation_policy ) ) {
			$_wcfm_product_cancellation_policy = $_wcfm_cancellation_policy;
		}
	...
	function wcfm_policy_product_settings_update( $new_product_id, $wcfm_products_manage_form_data ) {
		...
		$wcfm_policy_product_options = get_post_meta( $new_product_id, 'wcfm_policy_product_options', true ) ? (array) get_post_meta( $new_product_id, 'wcfm_policy_product_options', true ) : array();
	...
	public function get_policy_tab_title( $product_id = 0 ) {
		...
		if ( wcfm_empty( $_wcfm_product_policy_tab_title ) ) {
			$_wcfm_product_policy_tab_title = __( 'Store Policies', 'wc-frontend-manager' );
		}
	...
	function wcmp_general_policies_tab_disable( $subtabs, $tab ) {
		global $WCMp;
		if ( $tab == 'general' ) {
			if ( isset( $subtabs['policies'] ) ) {
				unset( $subtabs['policies'] );
			}
		}
		return $subtabs;
	}
