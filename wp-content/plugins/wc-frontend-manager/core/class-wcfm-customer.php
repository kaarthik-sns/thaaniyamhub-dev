...
class WCFM_Customer {
	...
	function customers_wcfm_menus( $menus ) {
		...
		$customers_menus = array(
			'wcfm-customers' => array(
	...
	public function wcfm_customers_load_scripts( $end_point ) {
		...
		switch ( $end_point ) {
			case 'wcfm-customers':
				...
				if ( isset( $wcfm_screen_manager['customer'] ) ) {
					$wcfm_screen_manager_data = $wcfm_screen_manager['customer'];
				}
