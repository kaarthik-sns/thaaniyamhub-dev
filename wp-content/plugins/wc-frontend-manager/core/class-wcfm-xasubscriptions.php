...
class WCFM_XASubscriptions {
	...
	function wcfmcap_product_types( $product_types, $handler = 'wcfm_capability_options', $wcfm_capability_options = array() ) {
		...
		$product_types['subscription'] = array(
			'label'       => __( 'Subscriptions', 'wc-frontend-manager' ),
			'name'        => $handler . '[subscription]',
			'type'        => 'checkboxoffon',
			'class'       => 'wcfm-checkbox wcfm_ele',
			'value'       => 'yes',
			'label_class' => 'wcfm_title checkbox_title',
			'dfvalue'     => $subscription,
		);
	...
	function wcs_product_manage_fields_pricing( $general_fields, $product_id ) {
		...
		$general_fields = array_slice( $general_fields, 0, 3, true ) +
																	array(
																		'_hf_subscription_price' => array(
																			'label'       => sprintf( esc_html__( 'Subscription price (%s)', 'xa-woocommerce-subscription' ), esc_html( get_woocommerce_currency_symbol() ) ),
																			'type'        => 'text',
																			'class'       => 'wcfm-text wcfm_ele subscription_price_ele subscription',
																			'label_class' => 'wcfm_title wcfm_ele subscription',
																			'hints'       => __( 'Choose the subscription price, billing interval and period.', 'xa-woocommerce-subscription' ),
																			'value'       => $chosen_price,
																		),
																		...
																		'_subscription_length_day' => array(
																			'label'       => __( 'Subscription length', 'xa-woocommerce-subscription' ),
																			'type'        => 'select',
																			'options'     => Hforce_Date_Time_Utils::hforce_get_subscription_ranges( 'day' ),
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele subscription_length_day subscription',
																			'label_class' => 'wcfm_title wcfm_ele subscription_length_ele subscription_length_day subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'xa-woocommerce-subscription' ),
																			'value'       => $subscription_length,
																		),
																		'_subscription_length_week' => array(
																			'label'       => __( 'Subscription length', 'xa-woocommerce-subscription' ),
																			'type'        => 'select',
																			'options'     => Hforce_Date_Time_Utils::hforce_get_subscription_ranges( 'week' ),
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele subscription_length_week subscription',
																			'label_class' => 'wcfm_title wcfm_ele subscription_length_ele subscription_length_week subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'xa-woocommerce-subscription' ),
																			'value'       => $subscription_length,
																		),
																		'_subscription_length_month' => array(
																			'label'       => __( 'Subscription length', 'xa-woocommerce-subscription' ),
																			'type'        => 'select',
																			'options'     => Hforce_Date_Time_Utils::hforce_get_subscription_ranges( 'month' ),
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele subscription_length_month subscription',
																			'label_class' => 'wcfm_title wcfm_ele subscription_length_ele subscription_length_month subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'xa-woocommerce-subscription' ),
																			'value'       => $subscription_length,
																		),
																		'_subscription_length_year' => array(
																			'label'       => __( 'Subscription length', 'xa-woocommerce-subscription' ),
																			'type'        => 'select',
																			'options'     => Hforce_Date_Time_Utils::hforce_get_subscription_ranges( 'year' ),
																			'class'       => 'wcfm-select wcfm_ele subscription_length_ele subscription_length_year subscription',
																			'label_class' => 'wcfm_title wcfm_ele subscription_length_ele subscription_length_year subscription',
																			'hints'       => __( 'Automatically expire the subscription after this length of time. This length is in addition to any free trial or amount of time provided before a synchronised first renewal date.', 'xa-woocommerce-subscription' ),
																			'value'       => $subscription_length,
																		),
																	) +
