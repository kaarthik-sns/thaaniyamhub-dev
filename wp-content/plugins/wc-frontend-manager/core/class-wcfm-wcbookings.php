...
class WCFM_WCBookings {
	...
	function wcb_wcfm_query_vars( $query_vars ) {
		...
		if ( isset( $wcfm_modified_endpoints['wcfm-bookings'] ) && ! empty( $wcfm_modified_endpoints['wcfm-bookings'] ) && $wcfm_modified_endpoints['wcfm-bookings'] == 'bookings' ) {
			$wcfm_modified_endpoints['wcfm-bookings'] = 'bookingslist';
		}
	...
	function wcfmcap_product_types( $product_types, $handler = 'wcfm_capability_options', $wcfm_capability_options = array() ) {
		...
		$product_types['booking'] = array(
			'label'       => __( 'Bookable', 'wc-frontend-manager' ),
			'name'        => $handler . '[booking]',
			'type'        => 'checkboxoffon',
			...
			<div id="wcfm_products_manage_form_booking_options_expander" class="wcfm-content">
				<?php
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_wcbokings_general_fields',
							array(

								'_wc_booking_duration_type' => array(
									'label'       => __( 'Booking duration', 'woocommerce-bookings' ),
									'type'        => 'select',
									'options'     => array(
										'fixed'    => __( 'Fixed blocks of', 'woocommerce-bookings' ),
										'customer' => __( 'Customer defined blocks of', 'woocommerce-bookings' ),
									),
									'class'       => 'wcfm-select wcfm_ele booking',
									'label_class' => 'wcfm_title booking',
									'value'       => $duration_type,
								),
								'_wc_booking_duration'     => array(
									'type'        => 'number',
								...
								'_wc_booking_duration_unit' => array(
									'type'        => 'select',
									'options'     => array(
										'month'  => __( 'Month(s)', 'woocommerce-bookings' ),
										'day'    => __( 'Day(s)', 'woocommerce-bookings' ),
										'hour'   => __( 'Hour(s)', 'woocommerce-bookings' ),
										'minute' => __( 'Minute(s)', 'woocommerce-bookings' ),
									),
									'class'       => 'wcfm-select wcfm_ele booking',
									'label_class' => 'wcfm_title booking',
									'value'       => $duration_unit,
								),
								'_wc_booking_min_duration' => array(
									'label'       => __( 'Minimum duration', 'woocommerce-bookings' ),
									'type'        => 'number',
									'class'       => 'wcfm-text wcfm_ele duration_type_customer_ele booking',
									'label_class' => 'wcfm_title duration_type_customer_ele booking',
									'value'       => $min_duration,
									'hints'       => __( 'The minimum allowed duration the user can input.', 'woocommerce-bookings' ),
									'attributes'  => array(
										'min'  => '1',
										'step' => '1',
									),
								),
								'_wc_booking_max_duration' => array(
									'label'       => __( 'Maximum duration', 'woocommerce-bookings' ),
									'type'        => 'number',
									'class'       => 'wcfm-text wcfm_ele duration_type_customer_ele booking',
									'label_class' => 'wcfm_title duration_type_customer_ele booking',
									'value'       => $max_duration,
									'hints'       => __( 'The maximum allowed duration the user can input.', 'woocommerce-bookings' ),
									'attributes'  => array(
										'min'  => '1',
										'step' => '1',
									),
								),
								'_wc_booking_enable_range_picker' => array(
									'label'       => __( 'Enable Calendar Range Picker?', 'woocommerce-bookings' ),
									'type'        => 'checkbox',
									'class'       => 'wcfm-checkbox wcfm_ele duration_type_customer_ele booking',
									'label_class' => 'wcfm_title duration_type_customer_ele booking',
									'value'       => 'yes',
									'dfvalue'     => $enable_range_picker,
									'hints'       => __( 'Lets the user select a start and end date on the calendar - duration will be calculated automatically.', 'woocommerce-bookings' ),
								),
								'_wc_booking_calendar_display_mode' => array(
								...
								'_wc_booking_requires_confirmation' => array(
									...
									'hints'       => __( 'Check this box if the booking requires admin approval/confirmation. Payment will not be taken during checkout.', 'woocommerce-bookings' ),
								),
								'_wc_booking_user_can_cancel' => array(
								...
								'_wc_booking_cancel_limit' => array(
									'label'       => __( 'Booking can be cancelled until', 'woocommerce-bookings' ),
									'type'        => 'number',
									'class'       => 'wcfm-text wcfm_ele can_cancel_ele booking',
									'label_class' => 'wcfm_title can_cancel_ele booking',
									'value'       => $cancel_limit,
								),
								'_wc_booking_cancel_limit_unit' => array(
									'type'        => 'select',
									'options'     => array(
										'month'  => __( 'Month(s)', 'woocommerce-bookings' ),
										'day'    => __( 'Day(s)', 'woocommerce-bookings' ),
									...
									'label_class' => 'wcfm_title can_cancel_ele booking',
									'desc_class'  => 'can_cancel_ele in_the_future booking',
