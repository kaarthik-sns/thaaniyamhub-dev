			...
			<form action="" method="post" id="wcfm_enquiry_form" class="enquiry-form" novalidate="">
				...
				if ( ! empty( $wcfm_enquiry_custom_fields ) ) {
					foreach ( $wcfm_enquiry_custom_fields as $wcfm_enquiry_custom_field ) {
						...
						if ( isset( $wcfm_enquiry_custom_field['required'] ) && $wcfm_enquiry_custom_field['required'] ) {
						...
						switch ( $wcfm_enquiry_custom_field['type'] ) {
							...
							case 'upload':
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									array(
										$field_id => array(
											'label'       => __( $wcfm_enquiry_custom_field['label'], 'wc-frontend-manager' ),
											'name'        => $field_name,
											'custom_attributes' => $custom_attributes,
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_popup_input',
											'label_class' => 'wcfm_title wcfm_popup_label',
											'value'       => $field_value,
											'hints'       => __( $wcfm_enquiry_custom_field['help_text'], 'wc-frontend-manager' ),
										),
									)
								);
								break;
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									array(
										$field_id => array(
											...
											'custom_attributes' => $custom_attributes,
											'type'        => 'textarea',
											'class'       => 'wcfm-textarea wcfm_popup_input',
											'label_class' => 'wcfm_title wcfm_popup_label',
											'value'       => $field_value,
											'hints'       => __( $wcfm_enquiry_custom_field['help_text'], 'wc-frontend-manager' ),
										),
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									array(
										$field_id => array(
											...
											'class'       => 'wcfm-text wcfm_datepicker wcfm_popup_input',
											'label_class' => 'wcfm_title wcfm_popup_label',
											'value'       => $field_value,
											'hints'       => __( $wcfm_enquiry_custom_field['help_text'], 'wc-frontend-manager' ),
										),
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									array(
										$field_id => array(
											...
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox',
											'label_class' => 'wcfm_title checkbox-title wcfm_popup_label',
											'value'       => 'yes',
											'dfvalue'     => $field_value,
											'hints'       => __( $wcfm_enquiry_custom_field['help_text'], 'wc-frontend-manager' ),
										),
