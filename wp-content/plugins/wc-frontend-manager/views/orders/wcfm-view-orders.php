			...
			if ( ! wcfm_is_vendor() ) {
				...
				<div class="wcfm_orders_filter_wrap wcfm_filters_wrap">
					...
					if ( $is_marketplace && ( $is_marketplace == 'wcfmmarketplace' ) ) {
						$vendor_arr = array();  
						if ( $order_vendor ) {
							$vendor_arr = array( $order_vendor => wcfm_get_vendor_store_name( $order_vendor ) );
						}
					...
					<thead>
						<tr>                                                                                      
							...
							<?php } elseif ( wcfm_is_vendor() ) { ?>
								<th>
								<?php
								printf( apply_filters( 'wcfm_vendors_earned_label', __( 'Earning', 'wc-frontend-manager' ) ) );
								_e( ' Amount', 'wc-frontend-manager' );
								?>
								</th>
							<?php } else { ?>
								<th>
								<?php
								printf( apply_filters( 'wcfm_vendors_earned_commission_label', __( 'Vendor Earning', 'wc-frontend-manager' ) ) );
								_e( ' Amount', 'wc-frontend-manager' );
								?>
								</th>
							<?php } ?>
