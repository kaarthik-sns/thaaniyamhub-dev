...
<div class="collapse wcfm-collapse">
	...
	<div class="wcfm-collapse-content">
		...
		<?php
		if ( $customer_id ) {
			_e( 'Edit Customer', 'wc-frontend-manager' );
		} else {
			_e( 'Add Customer', 'wc-frontend-manager' ); }
		?>
		</h2>
			...
			<div class="wcfm-container">
				<div id="customers_manage_general_expander" class="wcfm-content">
						...
						if ( $customer_id ) {
							...
							$customer_fields_general = apply_filters(
								'wcfm_customer_fields_general',
								array(
									'user_email'  => array(
									...
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										apply_filters(
											...
											array(
												...
												'bcompany_name' => array(
													'label' => __( 'Company Name', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele ',
													'label_class' => 'wcfm_ele wcfm_title',
													'value' => $bcompany_name,
									...
									apply_filters(
										...
										array(
											...
											'scompany_name' => array(
												...
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele same_as_billing_ele',
												'label_class' => 'wcfm_ele wcfm_title same_as_billing_ele',
												'value' => $scompany_name,
											),
											'saddr_1'     => array(
												'label' => __( 'Address 1', 'wc-frontend-manager' ),
