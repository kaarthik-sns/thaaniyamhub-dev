			...
			<?php if ( WCFM_Dependencies::wcfm_all_in_one_seo_plugin_active_check() || WCFM_Dependencies::wcfm_all_in_one_seo_pro_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple variable external grouped booking">
					<div id="wcfm_products_manage_form_yoast_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'wcfm_products_manage_fields_aiosp',
								array(
									'aiosp_title'       => array(
			...
			<?php if ( WCFM_Dependencies::wcfm_rankmath_seo_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple variable external grouped booking">
					<div id="wcfm_products_manage_form_yoast_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'wcfm_products_manage_fields_rank_math',
								array(
		...
		<?php if ( WCFM_Dependencies::wcfm_wc_tabs_lite_plugin_active_check() ) { ?>
			...
			<div class="wcfm-container simple variable external grouped booking">
				<div id="wcfm_products_manage_form_wc_tabs_lite_expander" class="wcfm-content">
					...
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'product_manage_fields_wc_tabs_lite',
							array(
								'product_tabs' => array(
									'label'       => __( 'Tabs', 'wc-frontend-manager' ),
									'type'        => 'multiinput',
									...
									'options'     => array(
										'title'   => array(
											...
											'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
											'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
											'hints'       => __( 'Required for tab to be visible', 'wc-frontend-manager' ),
										),
										'content' => array(
											...
											'class'       => 'wcfm-textarea wcfm_ele simple variable external grouped booking',
											'label_class' => 'wcfm_ele wcfm_title simple variable external grouped booking',
											'placeholder' => __( 'HTML or Text to display ...', 'wc-frontend-manager' ),
										),
									),
								),
							)
			...
			<?php if ( WCFM_Dependencies::wcfm_wc_barcode_isbn_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple external non-variable-subscription">
					<div id="wcfm_products_manage_form_barcode_isbn_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'product_manage_fields_barcode_isbn',
								array(
									'barcode' => array(
										'label'       => __( 'Barcode', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple external non-variable-subscription',
										'label_class' => 'wcfm_title wcfm_ele simple external non-variable-subscription',
										'value'       => $barcode,
									),
									'ISBN'    => array(
										'label'       => __( 'ISBN', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple external non-variable-subscription',
			...
			<?php if ( WCFM_Dependencies::wcfm_wc_msrp_pricing_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple external non-variable-subscription">
					<div id="wcfm_products_manage_form_msrp_pricing_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'product_manage_fields_msrp_pricing',
								array(
									'_msrp_price' => array(
										'label'       => __( 'MSRP Price', 'wc-frontend-manager' ) . '(' . get_woocommerce_currency_symbol() . ')',
										'type'        => 'number',
										'class'       => 'wcfm-text wcfm_ele simple external non-variable-subscription wcfm_non_negative_input',
										'label_class' => 'wcfm_title wcfm_ele simple external non-variable-subscription',
										'value'       => $msrp_price,
									),
								)
			...
			<?php if ( WCFM_Dependencies::wcfm_wc_quantities_units_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple variable external grouped booking">
					<div id="wcfm_products_manage_form_quantities_units_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'product_manage_fields_quantities_units',
								array(
									'_wpbo_deactive'    => array(
										'label'       => __( 'Deactivate Quantity Rules', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'class'       => 'wcfm-checkbox wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => 'on',
										'dfvalue'     => $_wpbo_deactive,
									),
									'_wpbo_override'    => array(
										'label'       => __( 'Override Quantity Rules', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'class'       => 'wcfm-checkbox wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => 'on',
										'dfvalue'     => $_wpbo_override,
									),
									'_wpbo_step'        => array(
										'label'       => __( 'Step Value', 'wc-frontend-manager' ),
										'type'        => 'number',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $_wpbo_step,
									...
									'_wpbo_minimum'     => array(
										'label'       => __( 'Minimum Quantity', 'wc-frontend-manager' ),
										'type'        => 'number',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $_wpbo_minimum,
									...
									'_wpbo_maximum'     => array(
										'label'       => __( 'Maximum Quantity', 'wc-frontend-manager' ),
										'type'        => 'number',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $_wpbo_maximum,
									),
									'_wpbo_minimum_oos' => array(
										'label'       => __( 'Out of Stock Minimum', 'wc-frontend-manager' ),
										'type'        => 'number',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $_wpbo_minimum_oos,
									),
									'_wpbo_maximum_oos' => array(
										'label'       => __( 'Out of Stock Maximum', 'wc-frontend-manager' ),
										'type'        => 'number',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $_wpbo_maximum_oos,
									),
									'unit'              => array(
										'label'       => __( 'Unit', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $unit,
			...
			<?php if ( WCFM_Dependencies::wcfm_wc_product_fees_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple variable external grouped booking">
					<div id="wcfm_products_manage_form_product_fees_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'product_manage_fields_product_fees',
								array(
									'product-fee-name'   => array(
										'label'       => __( 'Fee Name', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
										'value'       => $product_fee_name,
										'hints'       => __( 'This will be shown at the checkout description the added fee.', 'wc-frontend-manager' ),
									),
									'product-fee-amount' => array(
										'label'       => __( 'Fee Amount', 'wc-frontend-manager' ) . '(' . get_woocommerce_currency_symbol() . ')',
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_ele wcfm_title simple variable external grouped booking',
										'value'       => $product_fee_amount,
										'hints'       => __( 'Enter a monetary decimal without any currency symbols or thousand separator. This field also accepts percentages.', 'wc-frontend-manager' ),
									),
									'product-fee-multiplier' => array(
										'label'       => __( 'Multiple Fee by Quantity', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'class'       => 'wcfm-checkbox wcfm_ele simple variable external grouped booking',
										'value'       => 'yes',
										'label_class' => 'wcfm_title checkbox_title simple variable external grouped booking',
										'hints'       => __( 'Multiply the fee by the quantity of this product that is added to the cart.', 'wc-frontend-manager' ),
										'dfvalue'     => $product_fee_multiplier,
									),
								)
							)
						);
			...
			<?php if ( WCFM_Dependencies::wcfm_wc_bulk_discount_plugin_active_check() ) { ?>
				...
				<div class="wcfm-container simple variable external grouped booking">
					<div id="wcfm_products_manage_form_bulk_discount_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'product_manage_fields_bulk_discount',
								array(
									'_bulkdiscount_enabled' => array(
										'label'       => __( 'Bulk Discount enabled', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'class'       => 'wcfm-checkbox wcfm_ele simple variable external grouped booking',
										'value'       => 'yes',
										'label_class' => 'wcfm_title checkbox_title simple variable external grouped booking',
										'dfvalue'     => $_bulkdiscount_enabled,
									),
									'_bulkdiscount_text_info' => array(
										'label'       => __( 'Bulk discount special offer text in product description', 'wc-frontend-manager' ),
										'type'        => 'textarea',
										'class'       => 'wcfm-textarea wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_ele wcfm_title simple variable external grouped booking',
										'value'       => $_bulkdiscount_text_info,
									),
									'_bulkdiscounts' => array(
										'label'       => __( 'Discount Rules', 'wc-frontend-manager' ),
										'type'        => 'multiinput',
										'custom_attributes' => array( 'limit' => 5 ),
										'class'       => 'wcfm-text wcfm_ele simple variable external grouped booking',
										'label_class' => 'wcfm_title',
										'value'       => $_bulkdiscounts,
										'options'     => array(
											'quantity' => array(
												'label' => __( 'Quantity (min.)', 'wc-frontend-manager' ),
												'type'  => 'number',
												'class' => 'wcfm-text wcfm_ele simple variable external grouped booking',
												'label_class' => 'wcfm_title',
											),
											'discount' => array(
												'label' => __( 'Discount (%)', 'wc-frontend-manager' ),
												'type'  => 'number',
												'class' => 'wcfm-text wcfm_ele simple variable external grouped booking',
												'label_class' => 'wcfm_title',
											),
						...
						if ( ! empty( $wc_rbp_general ) ) {
							...
							if ( ! empty( $wc_rbp_allowed_roles ) ) {
								foreach ( $wc_rbp_allowed_roles as $wc_rbp_allowed_role ) {
									...
									if ( isset( $wp_roles[ $wc_rbp_allowed_role ] ) ) {
										echo '<h2>' . $wp_roles[ $wc_rbp_allowed_role ]['name'] . '</h2><div class="wcfm-clearfix"></div>';
									}
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										array(
											'_role_based_regular_price' => array(
												'label' => $wc_rbp_regular_price_label,
												'name'  => 'role_based_price[' . $wc_rbp_allowed_role . '][regular_price]',
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele simple external grouped',
												'label_class' => 'wcfm_ele wcfm_title simple external grouped',
												'value' => $regular_price,
											),
											'_role_based_sale_price'    => array(
												'label' => $wc_rbp_selling_price_label,
												'name'  => 'role_based_price[' . $wc_rbp_allowed_role . '][selling_price]',
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele simple external grouped',
												'label_class' => 'wcfm_ele wcfm_title simple external grouped',
												'value' => $selling_price,
