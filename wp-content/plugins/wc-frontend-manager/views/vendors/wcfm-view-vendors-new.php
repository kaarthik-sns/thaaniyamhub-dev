...
<div class="collapse wcfm-collapse">
	...
	<div class="wcfm-collapse-content">
		...
		<?php
		if ( $vendor_id ) {
			echo apply_filters( 'wcfm_manage_vendor_heading', __( 'Edit', 'wc-frontend-manager' ) . ' ' . apply_filters( 'wcfm_sold_by_label', '', __( 'Store', 'wc-frontend-manager' ) ) . ' ' . __( 'Vendor', 'wc-frontend-manager' ) );
		} else {
			echo apply_filters( 'wcfm_manage_vendor_heading', __( 'Add', 'wc-frontend-manager' ) . ' ' . apply_filters( 'wcfm_sold_by_label', '', __( 'Store', 'wc-frontend-manager' ) ) . ' ' . __( 'Vendor', 'wc-frontend-manager' ) ); }
		?>
		</h2>
				...
				<div id="vendors_new_general_expander" class="wcfm-content">
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								array(
									'user_name' => array(
										'label'       => __( 'Username', 'wc-frontend-manager' ),
										'type'        => 'text',
