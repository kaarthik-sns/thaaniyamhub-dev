...
require_once $WCFM->plugin_path . 'includes/reports/class-dokan-report-sales-by-date.php';
...
$wcfm_report_sales_by_date->chart_colours = apply_filters(
	'wcfm_admin_sales_by_date_chart_colors',
	array(
		'sales_amount'    => '#b1d4ea',
		'average'         => '#b1d4ea',
		'earned'          => '#4bc0c0',
