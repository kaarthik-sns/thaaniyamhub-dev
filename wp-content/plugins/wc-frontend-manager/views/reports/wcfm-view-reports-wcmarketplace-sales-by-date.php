...
require_once $WCFM->plugin_path . 'includes/reports/class-wcmarketplace-report-sales-by-date.php';
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container">
			<div id="wcfm_reports_sales_by_date_expander" class="wcfm-content">
				...
				<?php
					require $WCFM->plugin_path . '/views/reports/wcfm-html-report-sales-by-date.php';
				?>
