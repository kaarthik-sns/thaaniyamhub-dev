...
<div class="collapse wcfm-collapse">
	...
	<div class="wcfm-collapse-content">
		...
		<?php
		if ( $knowledgebase_id ) {
			_e( 'Edit Knowledgebase', 'wc-frontend-manager' );
		} else {
			_e( 'Add Knowledgebase', 'wc-frontend-manager' ); }
		?>
		</h2>
					...
					<div class="wcfm_knowledgebase_manager_general_fields">
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'knowledgebase_manager_fields_general',
									array(
										'title'            => array(
											'placeholder' => __( 'Title', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_full_ele wcfm_ele',
											'label_class' => 'wcfm_title wcfm_ele',
											'value'       => $title,
										),
										'wcfm_knowledgebase' => array(
											'label'       => __( 'Details', 'wc-frontend-manager' ),
											'type'        => 'wpeditor',
											'class'       => 'wcfm-textarea wcfm_ele wcfm_wpeditor',
											'label_class' => 'wcfm_title',
											'rows'        => 20,
											'value'       => $content,
										),
										'knowledgebase_id' => array(
											'type'  => 'hidden',
