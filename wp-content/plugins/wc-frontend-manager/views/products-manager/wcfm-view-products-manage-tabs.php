...
?>
							...
							apply_filters(
								...
								array(
									'sku'               => array(
										...
										'value'       => $sku,
										'hints'       => __( 'SKU refers to a Stock-keeping unit, a unique identifier for each distinct product and service that can be purchased.', 'wc-frontend-manager' ),
									),
									'manage_stock'      => array(
										'label'       => __( 'Manage Stock?', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'class'       => 'wcfm-checkbox wcfm_ele simple variable manage_stock_ele non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking non-pw-gift-card',
										'value'       => 'enable',
										'label_class' => 'wcfm_title wcfm_ele checkbox_title simple variable non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking non-pw-gift-card',
										'hints'       => __( 'Enable stock management at product level', 'wc-frontend-manager' ),
									...
									'stock_qty'         => array(
										...
										'value'       => $stock_qty,
										'hints'       => __( 'Stock quantity. If this is a variable product this value will be used to control stock for all variations, unless you define stock at variation level.', 'wc-frontend-manager' ),
										'attributes'  => array(
											'min'  => '1',
											'step' => '1',
										),
									...
									'backorders'        => array(
										'label'       => __( 'Allow Backorders?', 'wc-frontend-manager' ),
										'type'        => 'select',
										'options'     => array(
											'no'     => __( 'Do not Allow', 'wc-frontend-manager' ),
											'notify' => __( 'Allow, but notify customer', 'wc-frontend-manager' ),
											'yes'    => __( 'Allow', 'wc-frontend-manager' ),
										),
										'class'       => 'wcfm-select wcfm_ele simple variable non_manage_stock_ele non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking',
										'label_class' => 'wcfm_title wcfm_ele simple variable non_manage_stock_ele non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking',
										'value'       => $backorders,
									...
									'stock_status'      => array(
										...
										'options'     => array(
											...
											'onbackorder' => __( 'On backorder', 'wc-frontend-manager' ),
										),
										'class'       => 'wcfm-select wcfm_ele stock_status_ele simple variable grouped non-variable-subscription non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking',
										'label_class' => 'wcfm_ele wcfm_title stock_status_ele simple variable grouped non-variable-subscription non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking',
										'value'       => $stock_status,
										'hints'       => __( 'Controls whether or not the product is listed as "in stock" or "out of stock" on the frontend.', 'wc-frontend-manager' ),
									),
									'sold_individually' => array(
										'label'       => __( 'Sold Individually', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'value'       => 'enable',
										'class'       => 'wcfm-checkbox wcfm_ele simple variable non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking',
										'hints'       => __( 'Enable this to only allow one of this item to be bought in a single order', 'wc-frontend-manager' ),
										'label_class' => 'wcfm_title wcfm_ele simple variable checkbox_title non-job_package non-resume_package non-auction non-redq_rental non-appointment non-accommodation-booking',
							...
							apply_filters(
								...
								array(
									...
									'download_limit'     => array(
										...
										'class'       => 'wcfm-text wcfm_ele simple external',
										'label_class' => 'wcfm_ele wcfm_title simple downlodable',
										'attributes'  => array(
											'min'  => '0',
											'step' => '1',
				...
				<div class="wcfm-container grouped">
					<div id="wcfm_products_manage_form_grouped_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'product_manage_fields_grouped',
								array(
									'grouped_products' => array(
										'label'       => __( 'Grouped products', 'wc-frontend-manager' ),
										'type'        => 'select',
										'attributes'  => array(
											'multiple' => 'multiple',
											'style'    => 'width: 60%;',
										),
										'class'       => 'wcfm-select wcfm_ele grouped',
										'label_class' => 'wcfm_title wcfm_ele grouped',
										'options'     => $products_array,
										'value'       => $children,
										'hints'       => __( 'This lets you choose which products are part of this group.', 'wc-frontend-manager' ),
									),
								),
								$product_id
							)
				...
				<div class="wcfm-container <?php echo $wcfm_pm_block_class_shipping . ' ' . $wcfm_wpml_edit_disable_element; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_shipping', '' ); ?>">
					<div id="wcfm_products_manage_form_shipping_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'wcfm_product_manage_fields_shipping',
								array(
									'weight'         => array(
										'label'       => __( 'Weight', 'wc-frontend-manager' ) . ' (' . get_option( 'woocommerce_weight_unit', 'kg' ) . ')',
										'type'        => 'text',
									...
									'length'         => array(
										'label'       => __( 'Dimensions', 'wc-frontend-manager' ) . ' (' . get_option( 'woocommerce_dimension_unit', 'cm' ) . ')',
										'placeholder' => __( 'Length', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple variable booking',
										'label_class' => 'wcfm_title',
										'value'       => $length,
									...
									'width'          => array(
										'placeholder' => __( 'Width', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple variable booking',
										'label_class' => 'wcfm_title',
										'value'       => $width,
									...
									'height'         => array(
										'placeholder' => __( 'Height', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele simple variable booking',
										'label_class' => 'wcfm_title',
										'value'       => $height,
									...
									'shipping_class' => array(
										'label'       => __( 'Shipping class', 'wc-frontend-manager' ),
										'type'        => 'select',
										'options'     => $shipping_option_array,
				...
				<?php if ( wc_tax_enabled() ) { ?>
					...
					<div class="wcfm-container <?php echo $wcfm_pm_block_class_tax . ' ' . $wcfm_wpml_edit_disable_element; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>">
						<div id="wcfm_products_manage_form_tax_expander" class="wcfm-content">
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_product_simple_fields_tax',
									array(
										'tax_status' => array(
											'label'       => __( 'Tax Status', 'wc-frontend-manager' ),
											'type'        => 'select',
											'options'     => array(
												'taxable'  => __( 'Taxable', 'wc-frontend-manager' ),
												'shipping' => __( 'Shipping only', 'wc-frontend-manager' ),
												'none'     => _x( 'None', 'Tax status', 'wc-frontend-manager' ),
											),
											'class'       => 'wcfm-select wcfm_ele simple variable booking',
											'label_class' => 'wcfm_title',
											'value'       => $tax_status,
											'hints'       => __( 'Define whether or not the entire product is taxable, or just the cost of shipping it.', 'wc-frontend-manager' ),
										),
										'tax_class'  => array(
											'label'       => __( 'Tax Class', 'wc-frontend-manager' ),
											'type'        => 'select',
											'options'     => $tax_classes_options,
											'class'       => 'wcfm-select wcfm_ele simple variable booking',
											'label_class' => 'wcfm_title',
											'value'       => $tax_class,
											'hints'       => __( 'Choose a tax class for this product. Tax classes are used to apply different tax rates specific to certain types of product.', 'wc-frontend-manager' ),
										),
									),
									$product_id
								)
				...
				<div class="wcfm-container <?php echo $wcfm_pm_block_class_attributes; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_attributes', '' ); ?>">
					<div id="wcfm_products_manage_form_attribute_expander" class="wcfm-content">
						...
						<?php
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'product_simple_fields_attributes',
									array(
										'attributes' => array(
											'label'       => __( 'Attributes', 'wc-frontend-manager' ),
											'type'        => 'multiinput',
											'class'       => 'wcfm-text wcfm_input_attributes wcfm_ele simple variable external grouped booking',
											'has_dummy'   => true,
											'label_class' => 'wcfm_title',
											'value'       => $attributes,
											'options'     => array(
												...
												'is_active' => array(
													...
													'type' => 'checkbox',
													'value' => 'enable',
													'class' => 'wcfm-checkbox wcfm_ele attribute_ele simple variable external grouped booking',
													'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking checkbox_title',
												),
												'name'     => array(
													'label' => __( 'Name', 'wc-frontend-manager' ),
													'type' => 'text',
												...
												'value'    => array(
													...
													'placeholder' => sprintf( __( 'Enter some text, some attributes by "%s" separating values.', 'wc-frontend-manager' ), WC_DELIMITER ),
													'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking',
												),
												'is_visible' => array(
					...
					<div id="wcfm_products_manage_form_variations_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							array(
								'variations' => array(
									'type'        => 'multiinput',
									'class'       => 'wcfm_ele variable variable-subscription pw-gift-card',
									'label_class' => 'wcfm_title',
									'value'       => $variations,
									'options'     =>
																																			apply_filters(
																																				...
																																				array(
																																					...
																																					'enable' => array(
																																						...
																																						'value'       => 'enable',
																																						'dfvalue'     => 'enable',
																																						'class'       => 'wcfm-checkbox wcfm_ele variable variable-subscription pw-gift-card',
																																					...
																																					'is_virtual' => array(
																																						...
																																						'type'        => 'checkbox',
																																						'value'       => 'enable',
																																						'class'       => 'wcfm-checkbox wcfm_ele variable variable-subscription pw-gift-card variation_is_virtual_ele',
																																						'label_class' => 'wcfm_title checkbox_title',
																																					),
																																					'manage_stock' => array(
																																						'label'       => __( 'Manage Stock', 'wc-frontend-manager' ),
																																						...
																																						'value'       => 'enable',
																																						'value'       => 'enable',
																																						'class'       => 'wcfm-checkbox wcfm_ele variable variable-subscription pw-gift-card variation_manage_stock_ele',
																																						'label_class' => 'wcfm_title checkbox_title',
																																					),
																																					...
																																					'image' => array(
																																						...
																																						'type'        => 'upload',
																																						'class'       => 'wcfm-text wcfm_ele variable variable-subscription pw-gift-card',
																																						'label_class' => 'wcfm_title wcfm_half_ele_upload_title',
																																					),
																																					'wcfm_element_breaker_variation_2' => array(
																																						'type'  => 'html',
																																						'value' => '<div class="wcfm-cearfix"></div>',
																																					),
																																					'regular_price' => array(
																																						...
																																						'type'        => 'number',
																																						'class'       => 'wcfm-text wcfm_ele wcfm_non_negative_input wcfm_half_ele variable pw-gift-card',
																																						'label_class' => 'wcfm_title wcfm_ele wcfm_half_ele_title variable pw-gift-card',
																																						'attributes'  => array(
																																							'min'  => '0.1',
																																							'step' => '0.1',
																																						),
																																					...
																																					'sale_price_dates_from' => array(
																																						...
																																						'class'       => 'wcfm-text wcfm_ele wcfm_half_ele var_sales_schedule_ele var_sale_date_from variable variable-subscription pw-gift-card',
																																						'label_class' => 'wcfm_ele wcfm_half_ele_title var_sales_schedule_ele variable variable-subscription pw-gift-card',
																																					),
																																					'sale_price_dates_to' => array(
																																						'label'       => __( 'Upto', 'wc-frontend-manager' ),
																																						'type'        => 'text',
																																						'placeholder' => __( 'To', 'wc-frontend-manager' ) . ' ... YYYY-MM-DD',
																																						'class'       => 'wcfm-text wcfm_ele wcfm_half_ele var_sales_schedule_ele var_sale_date_upto variable variable-subscription pw-gift-card',
																																						'label_class' => 'wcfm_ele wcfm_half_ele_title var_sales_schedule_ele wcfm_title variable variable-subscription pw-gift-card',
																																					),
																																					'stock_qty' => array(
																																						'label'       => __( 'Stock Qty', 'wc-frontend-manager' ),
																																						'type'        => 'number',
																																						'class'       => 'wcfm-text wcfm_ele wcfm_half_ele variable variable-subscription pw-gift-card variation_non_manage_stock_ele',
																																					...
																																					'backorders' => array(
																																						'label'       => __( 'Backorders?', 'wc-frontend-manager' ),
																																						'type'        => 'select',
																																						'options'     => array(
																																							'no'     => __( 'Do not Allow', 'wc-frontend-manager' ),
																																							'notify' => __( 'Allow, but notify customer', 'wc-frontend-manager' ),
																																						...
																																						'class'       => 'wcfm-select wcfm_ele wcfm_half_ele variable variable-subscription pw-gift-card variation_non_manage_stock_ele',
																																						'label_class' => 'wcfm_title wcfm_half_ele_title variation_non_manage_stock_ele',
																																					),
																																					'sku' => array(
																																						'label'       => __( 'SKU', 'wc-frontend-manager' ),
																																					...
																																					'stock_status' => array(
																																						...
																																						'class'       => 'wcfm-select wcfm_ele wcfm_half_ele variable variable-subscription pw-gift-card variation_stock_status_ele',
																																						'label_class' => 'wcfm_title wcfm_half_ele_title variation_stock_status_ele',
																																					),
																																					'attributes' => array( 'type' => 'hidden' ),
																																				),
																																				$variations,
																																				$variation_shipping_option_array,
																																				$variation_tax_classes_options,
																																				$products_array,
																																				$product_id,
																																				$product_type
																																			),
				...
				<div class="wcfm-container <?php echo $wcfm_pm_block_class_linked . ' ' . $wcfm_wpml_edit_disable_element; ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_linked', '' ); ?>">
					<div id="wcfm_products_manage_form_linked_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field(
							apply_filters(
								'wcfm_product_manage_fields_linked',
								array(
									'upsell_ids'    => array(
										'label'       => __( 'Up-sells', 'wc-frontend-manager' ),
										'type'        => 'select',
										'attributes'  => array(
											'multiple' => 'multiple',
											'style'    => 'width: 60%;',
										...
										'options'     => $products_array,
										'value'       => $upsell_ids,
										'hints'       => __( 'Up-sells are products which you recommend instead of the currently viewed product, for example, products that are more profitable or better quality or more expensive.', 'wc-frontend-manager' ),
									),
									'crosssell_ids' => array(
										'label'       => __( 'Cross-sells', 'wc-frontend-manager' ),
										'type'        => 'select',
										'attributes'  => array(
											'multiple' => 'multiple',
											'style'    => 'width: 60%;',
										...
										'options'     => $products_array,
										'value'       => $crosssell_ids,
										'hints'       => __( 'Cross-sells are products which you promote in the cart, based on the current product.', 'wc-frontend-manager' ),
									),
								),
								$product_id,
								$products_array
