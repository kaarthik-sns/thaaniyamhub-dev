...
<div class="collapse wcfm-collapse">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<?php
			if ( $coupon_id ) {
				_e( 'Edit Coupon', 'wc-frontend-manager' );
			} else {
				_e( 'Add Coupon', 'wc-frontend-manager' ); }
			?>
			</h2>
			<?php
			if ( $coupon_id ) {
				...
				<div id="coupons_manage_general_expander" class="wcfm-content">
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'coupon_manager_fields_general',
									array(
										'title'         => array(
											'label'       => __( 'Code', 'wc-frontend-manager' ),
											'type'        => 'text',
										...
										'discount_type' => array(
											'label'       => __( 'Discount Type', 'wc-frontend-manager' ),
											'type'        => 'select',
											'options'     => apply_filters(
												...
												apply_filters(
													...
													array(
														'percent' => __( 'Percentage discount', 'wc-frontend-manager' ),
														'fixed_cart' => __( 'Fixed Cart Discount', 'wc-frontend-manager' ),
														'fixed_product' => __( 'Fixed Product Discount', 'wc-frontend-manager' ),
													)
												)
											),
										...
										'coupon_amount' => array(
											'label'       => __( 'Coupon Amount', 'wc-frontend-manager' ),
											'type'        => 'number',
										...
										'expiry_date'   => array(
											'label'       => __( 'Coupon expiry date', 'wc-frontend-manager' ),
											'type'        => 'text',
											'placeholder' => 'YYYY-MM-DD',
											'custom_attributes' => array( 'date_format' => 'yy-mm-dd' ),
											'class'       => 'wcfm-text wcfm_ele wcfm_datepicker',
											'label_class' => 'wcfm_ele wcfm_title',
											'value'       => $expiry_date,
										),
										'coupon_id'     => array(
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									array(
										'free_shipping' => array(
											...
											'hints'       => __( 'Check this box if the coupon grants free shipping. The free shipping method must be enabled and be set to require "a valid free shipping coupon" (see the "Free Shipping Requires" setting).', 'wc-frontend-manager' ),
											'dfvalue'     => $free_shipping,
										),
									)
								);
							}
							...
							if ( WCFM_Dependencies::dokanpro_plugin_active_check() || function_exists( 'wcfmmp_get_store_url' ) ) {
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									array(
										'show_on_store' => array(
											'label'       => __( 'Show on store', 'wc-frontend-manager' ),
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'value'       => 'yes',
											'label_class' => 'wcfm_title checkbox_title',
											'hints'       => __( 'Check this box if you want to show this coupon in store page.', 'wc-frontend-manager' ),
											'dfvalue'     => $show_on_store,
										),
									)
								);
							}
