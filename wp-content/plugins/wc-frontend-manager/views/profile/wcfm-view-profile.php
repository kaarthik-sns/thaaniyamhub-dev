...
$wp_user_avatar    = $wp_user_avatar_id;  
...
if ( wcfm_is_vendor() && apply_filters( 'wcfm_is_allow_email_verification', true ) ) {
	...
	if ( $user_id ) {
		...
		if ( $email_verified && ( $email != $wcfm_email_verified_for ) ) {
			$email_verified = false;
		}
	}
}
					...
					<div id="wcfm_profile_personal_expander" class="wcfm-content">
						<?php
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_profile_fields_general',
									array(
										'wp_user_avatar' => array(
											'label'       => __( 'Avatar', 'wc-frontend-manager' ),
											'type'        => 'upload',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'prwidth'     => 150,
											'value'       => $wp_user_avatar,
										),
										'first_name'     => array(
										...
										'email'          => array(
											...
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele ' . $wcfm_verification_code_sender,
											'label_class' => 'wcfm_title wcfm_ele',
							...
							if ( apply_filters( 'wcfm_is_allow_update_password', true ) ) {
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									apply_filters(
										'wcfm_profile_fields_password',
										array(
											'password' => array(
												'label' => __( 'Password', 'wc-frontend-manager' ),
												'type'  => 'password',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => '',
												'placeholder' => __( 'Set New Password – Leave blank to retain current password', 'wc-frontend-manager' ),
											),
							...
							if ( $languages ) {
								...
								$list_laguages = array(
									'site-default' => __( 'Site Default', 'wc-frontend-manager' ),
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									apply_filters(
										'wcfm_profile_fields_language',
										array(
											'locale' => array(
												'label'   => __( 'Language', 'wc-frontend-manager' ),
												'type'    => 'select',
												'options' => $list_laguages,
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_profile_fields_about',
									array(
										'about' => array(
											'label'       => __( 'About', 'wc-frontend-manager' ),
											'type'        => $wpeditor,
					...
					<div class="wcfm-container">
						<div id="wcfm_profile_form_social_expander" class="wcfm-content">
							<?php
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									apply_filters(
										'wcfm_profile_fields_social',
										array(
											'twitter'     => array(
												'label' => __( 'Twitter', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $twitter,
												'placeholder' => __( 'Twitter Handler', 'wc-frontend-manager' ),
											),
											'facebook'    => array(
												'label' => __( 'Facebook', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $facebook,
												'placeholder' => __( 'Facebook Handler', 'wc-frontend-manager' ),
											),
											'instagram'   => array(
												'label' => __( 'Instagram', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $instagram,
												'placeholder' => __( 'Instagram Username', 'wc-frontend-manager' ),
											),
											'youtube'     => array(
												'label' => __( 'Youtube', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $youtube,
												'placeholder' => __( 'YouTube Channel Name', 'wc-frontend-manager' ),
											),
											'linkdin'     => array(
												'label' => __( 'Linkedin', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $linkdin,
												'placeholder' => __( 'Linkdin Username', 'wc-frontend-manager' ),
											),
											'google_plus' => array(
												'label' => __( 'Google Plus', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $google_plus,
												'placeholder' => __( 'Google Plus Profile ID', 'wc-frontend-manager' ),
											),
											'snapchat'    => array(
												'label' => __( 'Snapchat', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $snapchat,
												'placeholder' => __( 'Snapchat ID', 'wc-frontend-manager' ),
											),
											'pinterest'   => array(
												'label' => __( 'Pinterest', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $pinterest,
												'placeholder' => __( 'Pinterest Username', 'wc-frontend-manager' ),
											),
										),
										$user_id
									)
