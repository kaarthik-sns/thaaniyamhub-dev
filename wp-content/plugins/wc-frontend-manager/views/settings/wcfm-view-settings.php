						...
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									...
									array(
										'wcfm_logo'     => array(
											'label'       => __( 'Logo', 'wc-frontend-manager' ),
											'type'        => 'upload',
										...
										'wcfm_quick_access_icon' => array(
											'label'       => __( 'Quick access icon', 'wc-frontend-manager' ),
											'type'        => 'upload',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'prwidth'     => 75,
											'value'       => $quick_access_image_url,
										),
										'wcfm_my_store_label' => array(
											'label'       => __( 'My Store Label', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'value'       => $wcfm_my_store_label,
										),
										'quick_access_disabled' => array(
											'label'       => __( 'Disable Quick Access', 'wc-frontend-manager' ),
										...
										'welcome_box_disabled' => array(
											'label'       => __( 'Disable Welcome Box', 'wc-frontend-manager' ),
										...
										'menu_disabled' => array(
											'label'       => __( 'Disable WCFM Menu', 'wc-frontend-manager' ),
											'name'        => 'menu_disabled',
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'value'       => 'yes',
											'label_class' => 'wcfm_title checkbox_title',
											'dfvalue'     => $is_menu_disabled,
										),
										'dashboard_theme_header_disabled' => array(
											'label'       => __( 'Disable Theme Header', 'wc-frontend-manager' ),
										...
										'dashboard_full_view_disabled' => array(
											'label'       => __( 'Disable WCFM Full View', 'wc-frontend-manager' ),
										...
										'slick_menu_disabled' => array(
											'label'       => __( 'Disable WCFM Slick Menu', 'wc-frontend-manager' ),
										...
										'headpanel_disabled' => array(
											'label'       => __( 'Disable WCFM Header Panel', 'wc-frontend-manager' ),
										...
										'float_button_disabled' => array(
											'label'       => __( 'Disable Float Button', 'wc-frontend-manager' ),
										...
										'checklist_view_disabled' => array(
											'label'       => __( 'Disable Category Checklist', 'wc-frontend-manager' ),
											...
											'hints'       => __( 'Disable this to have product manager category/custom taxonomy selector as search-list.', 'wc-frontend-manager' ),
										),
										'tags_input_disabled' => array(
											'label'       => __( 'Disable Tags Input Box', 'wc-frontend-manager' ),
											'name'        => 'tags_input_disabled',
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'value'       => 'yes',
											'label_class' => 'wcfm_title checkbox_title',
											'dfvalue'     => $is_tags_input_disabled,
											'hints'       => __( 'Disable this to have product manager tags input as drop-down, which will restrict to use only pre-defined tags.', 'wc-frontend-manager' ),
										),
										'wcfm_ultimate_notice_disabled' => array(
											'label'       => __( 'Disable Ultimate Notice', 'wc-frontend-manager' ),
											'name'        => 'wcfm_ultimate_notice_disabled',
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'value'       => 'yes',
											'label_class' => 'wcfm_title checkbox_title',
											'dfvalue'     => $wcfm_ultimate_notice_disabled,
										),
				...
				<div class="wcfm-container">
					<div id="wcfm_settings_form_modules_expander" class="wcfm-content">
						...
						foreach ( $wcfm_modules as $wcfm_module => $wcfm_module_data ) {
							...
							if ( isset( $wcfm_module_data['hints'] ) ) {
								$hints .= ': ' . $wcfm_module_data['hints']; }
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								array(
									$wcfm_module => array(
										'name'        => 'module_options[' . $wcfm_module . ']',
										'type'        => 'checkboxoffon',
										'class'       => 'wcfm-checkbox wcfm_ele',
										'value'       => 'yes',
										'label_class' => 'wcfm_title checkbox_title module_options_title',
										'dfvalue'     => $wcfm_module_value,
									),
								)
							);
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_settings_fields_analytics',
									array(
										'analytics_disabled' => array(
											'name'        => 'analytics_disabled',
											'type'        => 'checkboxoffon',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'value'       => 'yes',
											'label_class' => 'wcfm_title checkbox_title module_options_title',
											'dfvalue'     => $is_analytics_disabled,
										),
									)
								)
							);
							...
							} elseif ( $is_wcfma_inactive_notice_show = apply_filters( 'is_wcfma_inactive_notice_show', true ) ) {
				...
				<div class="wcfm-container">
					<div id="wcfm_settings_form_pages_expander" class="wcfm-content">
						...
						if ( isset( $wcfm_page_options['wcfm_affiliate_registration_page_id'] ) ) {
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_settings_fields_pages',
									array(
										'wcfm_refresh_permalink' => array(
											'label'       => __( 'Refresh Permalink', 'wc-frontend-manager' ),
											'name'        => 'wcfm_refresh_permalink',
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'value'       => 'yes',
											'label_class' => 'wcfm_title checkbox_title',
											'hints'       => __( 'Check to refresh WCfM page permalinks. Only apply if you are getting error (e.g. 404 not found) for any pages.', 'wc-frontend-manager' ),
										),
										'wc_frontend_manager_page_id' => array(
											'label'       => __( 'Dashboard', 'wc-frontend-manager' ),
											'type'        => 'select',
											'name'        => 'wcfm_page_options[wc_frontend_manager_page_id]',
											'options'     => $pages_array,
											'class'       => 'wcfm-select wcfm_ele',
											'label_class' => 'wcfm_title',
											'value'       => $wcfm_page_options['wc_frontend_manager_page_id'],
											'desc_class'  => 'wcfm_page_options_desc',
											'desc'        => __( 'This page should have shortcode - wc_frontend_manager', 'wc-frontend-manager' ) . '<br /><span style="color: #dd3333;">' . __( 'DO NOT USE WCFM DASHBOARD PAGE FOR OTHER PAGE SETTINGS, you will break your site if you do.', 'wc-frontend-manager' ) . '</span>',
										),
									)
								)
							);
						...
						<?php if ( $WCFM->is_marketplace && ( $WCFM->is_marketplace == 'wcfmmarketplace' ) ) { ?>
							...
							<div class="store_address">
								<?php
									...
									$wcfm_store_endpoints             = apply_filters(
										'wcfm_store_endpoints_slug',
										array(
											'about'      => 'about',
											'articles'   => 'articles',
											'policies'   => 'policies',
								...
								foreach ( $wcfm_store_endpoints as $wcfm_endpoint_key => $wcfm_endpoint_val ) {
									$wcfm_store_endpoints_edit_fileds[ $wcfm_endpoint_key ] = array(
										'label'       => $wcfm_endpoint_key,
										'name'        => 'wcfm_store_endpoints[' . $wcfm_endpoint_key . ']',
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele wcfm_slug_input',
										'placeholder' => $wcfm_endpoint_val,
										'value'       => ! empty( $wcfm_store_modified_endpoints[ $wcfm_endpoint_key ] ) ? $wcfm_store_modified_endpoints[ $wcfm_endpoint_key ] : '',
										'label_class' => 'wcfm_title',
									);
								}
						...
						<div class="store_address">
							<?php
								...
								$wcfm_myac_endpoints = apply_filters(
									'wcfm_myac_endpoints_slug',
									array(
										'inquiry'         => 'inquiry',
								...
								foreach ( $wcfm_myac_endpoints as $wcfm_endpoint_key => $wcfm_endpoint_val ) {
									$wcfm_myac_endpoints_edit_fileds[ $wcfm_endpoint_key ] = array(
										'label'       => $wcfm_endpoint_key,
										'id'          => 'wcfm_myac_endpoints_' . $wcfm_endpoint_key,
										'name'        => 'wcfm_myac_endpoints[' . $wcfm_endpoint_key . ']',
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele wcfm_slug_input',
										'placeholder' => $wcfm_endpoint_val,
										'value'       => ! empty( $wcfm_myac_modified_endpoints[ $wcfm_endpoint_key ] ) ? $wcfm_myac_modified_endpoints[ $wcfm_endpoint_key ] : '',
										'label_class' => 'wcfm_title',
									);
								}
						...
						<div id="wcfm_settings_form_manu_manager_expander" class="wcfm-content">
							...
							if ( apply_filters( 'wcfm_is_pref_withdrawal', true ) ) {
								if ( $is_marketplace && in_array( $is_marketplace, array( 'dokan', 'wcmarketplace', 'wcfmmarketplace' ) ) ) {
									$wcfm_menus['wcfm-payments']            = array(
										'label'    => __( 'Payments', 'wc-frontend-manager' ),
										'url'      => wcfm_payments_url(),
										'icon'     => 'credit-card',
										'menu_for' => 'vendor',
										'priority' => 38,
									);
									$wcfm_menus['wcfm-withdrawal-requests'] = array(
										'label'    => __( 'Withdrawal', 'wc-frontend-manager' ),
							...
							if ( $is_marketplace && WCFM_Dependencies::wcfmu_plugin_active_check() && apply_filters( 'wcfm_is_pref_vendor_followers', true ) && function_exists( 'wcfm_followers_url' ) ) {
								$wcfm_menus['wcfm-followers'] = array(
							...
							if ( $is_marketplace && ( $is_marketplace == 'wcfmmarketplace' ) ) {
								$wcfm_menus['wcfm-ledger']             = array(
									'label'    => __( 'Ledger Book', 'wc-multivendor-marketplace' ),
									'url'      => wcfm_ledger_url(),
									'icon'     => 'money',
									'menu_for' => 'vendor',
									'priority' => 69,
								);
								$wcfm_menus['wcfm-media']              = array(
									'label'    => __( 'Media', 'wc-multivendor-marketplace' ),
									'url'      => wcfm_media_url(),
									'icon'     => 'image',
									'menu_for' => 'both',
									'priority' => 3,
								);
								$wcfm_menus['wcfm-sell-items-catalog'] = array(
									'label'    => __( 'Add to My Store', 'wc-multivendor-marketplace' ),
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_menu_manager_fields',
									array(
										'wcfm_home_menu_label' => array(
											'label'       => __( 'Home Menu Label', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'value'       => $wcfm_home_menu_label,
										),
										'wcfm_menu_manager' => array(
											'type'        => 'multiinput',
											'class'       => 'wcfm-text wcfm_menu_manager_wrapper',
											'label_class' => 'wcfm_full_title',
											'value'       => $wcfm_formeted_menus,
											'options'     => array(
												'enable'   => array(
													'label' => __( 'Enable', 'wc-frontend-manager' ),
													'type' => 'checkbox',
													'class' => 'wcfm-checkbox wcfm_ele menu_manager_ele',
													'label_class' => 'wcfm_title checkbox-title',
													'value' => 'yes',
												),
												'label'    => array(
													'label' => __( 'Label', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele menu_manager_ele',
													'label_class' => 'wcfm_title',
												),
												'icon'     => array(
													'label' => __( 'Icon', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title',
													'hints' => __( 'Insert a valid Font-awesome icon class.', 'wc-frontend-manager' ),
												),
												'slug'     => array(
													'label' => __( 'Slug', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele wcfm_ele_hide',
													'label_class' => 'wcfm_title wcfm_ele_hide',
												),
												'url'      => array(
													'label' => __( 'URL', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title',
												),
												...
												'has_new'  => array(
													'label' => __( 'Has New?', 'wc-frontend-manager' ),
													'type' => 'checkbox',
													'class' => 'wcfm-checkbox wcfm_ele',
													'label_class' => 'wcfm_title checkbox_title',
													'value' => 'yes',
												...
												'new_label' => array(
													'label' => __( 'New Menu Class', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele wcfm_ele_hide',
													'label_class' => 'wcfm_title wcfm_ele_hide',
												),
												'new_url'  => array(
													'label' => __( 'New Menu URL', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title',
												),
												...
												'submenu_capability' => array(
													'label' => __( 'Sub Menu Capability', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele wcfm_ele_hide',
													'label_class' => 'wcfm_title wcfm_ele_hide',
												),
												'menu_for' => array(
													'label' => __( 'Menu For', 'wc-frontend-manager' ),
													'type' => 'select',
													'options' => array(
														'both' => __( 'All Users', 'wc-frontend-manager' ),
														'admin' => __( 'Only Admin', 'wc-frontend-manager' ),
														'vendor' => __( 'Only Vendors', 'wc-frontend-manager' ),
													),
													'class' => 'wcfm-select wcfm_ele',
													'label_class' => 'wcfm_title',
												),
												'new_tab'  => array(
													'label' => __( 'Open in new tab?', 'wc-frontend-manager' ),
													'type' => 'checkbox',
													'class' => 'wcfm-checkbox wcfm_ele',
													'label_class' => 'wcfm_title checkbox_title',
													'value' => 'yes',
				...
				<div class="wcfm-container">
					<div id="wcfm_settings_form_email_from_expander" class="wcfm-content">
						...
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_settings_fields_email_from',
									array(
										'email_from_name'  => array(
											'label'       => __( 'Email from name', 'wc-frontend-manager' ),
											'name'        => 'email_from_name',
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'value'       => $email_from_name,
											'label_class' => 'wcfm_title',
											'hints'       => __( 'Notification emails will be triggered with this name. By default Site Name will be used', 'wc-frontend-manager' ),
										),
										'email_from_address' => array(
											'label'       => __( 'Email from address', 'wc-frontend-manager' ),
											'name'        => 'email_from_address',
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'value'       => $email_from_address,
											'label_class' => 'wcfm_title',
											'hints'       => __( 'Notification emails will be triggered from this email address. By default Site Admin Email will be used', 'wc-frontend-manager' ),
										),
										'email_cc_address' => array(
											'label'       => __( 'CC Email address', 'wc-frontend-manager' ),
											'name'        => 'email_cc_address',
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'value'       => $email_cc_address,
											'label_class' => 'wcfm_title',
											'hints'       => __( 'Notification emails will be CC to this email address.', 'wc-frontend-manager' ),
										),
										'email_bcc_address' => array(
											'label'       => __( 'BCC Email address', 'wc-frontend-manager' ),
											'name'        => 'email_bcc_address',
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'value'       => $email_bcc_address,
											'label_class' => 'wcfm_title',
											'hints'       => __( 'Notification emails will be BCC to this email address.', 'wc-frontend-manager' ),
										),
									)
								)
							);
					...
					<div class="wcfm-container">
						<div id="wcfm_settings_form_enquiry_expander" class="wcfm-content">
							...
							$field_types = apply_filters(
								'wcfm_product_custom_filed_types',
								array(
									'text'       => 'Text',
									'number'     => 'Number',
									'textarea'   => 'textarea',
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_enquiry_custom_fields',
									array(
										'wcfm_enquiry_button_label' => array(
											'label'       => __( 'Button Label', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'value'       => $wcfm_enquiry_button_label,
										),
										'wcfm_enquiry_with_login' => array(
											'label'       => __( 'Require Login?', 'wc-frontend-manager' ),
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'label_class' => 'wcfm_title checkbox-title',
											'value'       => 'yes',
											'dfvalue'     => $wcfm_enquiry_with_login,
											'hints'       => __( 'Whether customer has to be logged-in to submit inquiry.', 'wc-frontend-manager' ),
										),
										'wcfm_enquiry_allow_attachment' => array(
											'label'       => __( 'Reply Attachment?', 'wc-frontend-manager' ),
											'type'        => 'checkbox',
											'class'       => 'wcfm-checkbox wcfm_ele',
											'label_class' => 'wcfm_title checkbox-title',
											'value'       => 'yes',
											'dfvalue'     => $wcfm_enquiry_allow_attachment,
											'hints'       => __( 'Whether vendors and customers are allowed to add attachment(s) with inquiry reply.', 'wc-frontend-manager' ),
										),
										'wcfm_enquiry_button_position' => array(
											'label'       => __( 'Button Position', 'wc-frontend-manager' ),
											'type'        => 'select',
											'options'     => array(
												'bellow_price' => __( 'Below Price', 'wc-frontend-manager' ),
												'bellow_sc'    => __( 'Below Short Description', 'wc-frontend-manager' ),
												'bellow_atc'   => __( 'Below Add to Cart', 'wc-frontend-manager' ),
											),
											'class'       => 'wcfm-select wcfm_ele',
											'label_class' => 'wcfm_title',
											'value'       => $wcfm_enquiry_button_position,
											'desc_class'  => 'wcfm_page_options_desc',
											'desc'        => __( 'Inquiry button display position at Single Product Page.', 'wc-frontend-manager' ),
										),
										'wcfm_enquiry_custom_fields' => array(
											'label'       => __( 'Inquiry Form Custom Fields', 'wc-frontend-manager' ),
											'type'        => 'multiinput',
											'class'       => 'wcfm-text wcfm_ele',
											'label_class' => 'wcfm_title',
											'value'       => $wcfm_enquiry_custom_fields,
											'options'     => array(
												'enable'   => array(
													'label' => __( 'Enable', 'wc-frontend-manager' ),
													'type' => 'checkbox',
												...
												'type'     => array(
													'label' => __( 'Field Type', 'wc-frontend-manager' ),
													'type' => 'select',
													'options' => $field_types,
													'class' => 'wcfm-select wcfm_ele field_type_options',
													'label_class' => 'wcfm_title',
												),
												'label'    => array(
													'label' => __( 'Label', 'wc-frontend-manager' ),
												...
												'options'  => array(
													'label' => __( 'Options', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele field_type_select_options',
													'label_class' => 'wcfm_title field_type_select_options',
													'placeholder' => __( 'Insert option values | separated', 'wc-frontend-manager' ),
												),
												'help_text' => array(
													'label' => __( 'Help Content', 'wc-frontend-manager' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title',
												),
												'required' => array(
													'label' => __( 'Required?', 'wc-frontend-manager' ),
													'type' => 'checkbox',
													'class' => 'wcfm-checkbox wcfm_ele',
													'label_class' => 'wcfm_title checkbox_title',
													'value' => 'yes',
						...
						<?php
							...
							if ( ! empty( $product_types ) ) {
								...
								<p class="wcfm_title catlimit_title"><strong>
									<?php
									echo esc_html( $product_type_label ) . ' ';
									_e( 'Categories', 'wc-frontend-manager' );
									?>
									</strong></p><label class="screen-reader-text" for="vendor_product_cats">
									<?php
