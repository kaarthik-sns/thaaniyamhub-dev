			...
			<div class="wcfm-tabWrap">
				...
				<div class="wcfm-container">
					<div id="wcfm_settings_form_store_expander" class="wcfm-content">
						<?php
							$wcvendors_settings_fields_general = apply_filters(
								'wcfm_wcvendors_settings_fields_general',
								array(
									'wcfm_logo'        => array(
									...
									'shop_name'        => array(
										'label'       => __( 'Shop Name', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele',
										'label_class' => 'wcfm_title wcfm_ele',
										'value'       => $shop_name,
										'hints'       => __( 'Your shop name is public and must be unique.', 'wc-frontend-manager' ),
									),
									'seller_info'      => array(
										'label'       => __( 'Seller Info', 'wc-frontend-manager' ),
										'type'        => 'textarea',
										'class'       => 'wcfm-textarea wcfm_ele',
										'label_class' => 'wcfm_title',
										'value'       => $seller_info,
										'hints'       => __( 'This is displayed on each of your products.', 'wc-frontend-manager' ),
									),
							...
							if ( ! apply_filters( 'wcfm_is_allow_store_logo', true ) ) {
								if ( isset( $wcvendors_settings_fields_general['wcfm_logo'] ) ) {
									unset( $wcvendors_settings_fields_general['wcfm_logo'] ); }
							}

							if ( ! apply_filters( 'wcfm_is_allow_store_name', true ) ) {
								if ( isset( $wcvendors_settings_fields_general['shop_name'] ) ) {
									unset( $wcvendors_settings_fields_general['shop_name'] ); }
							}

							if ( ! apply_filters( 'wcfm_is_allow_store_description', true ) ) {
								if ( isset( $wcvendors_settings_fields_general['seller_info'] ) ) {
									unset( $wcvendors_settings_fields_general['seller_info'] ); }
								if ( isset( $wcvendors_settings_fields_general['shop_description'] ) ) {
									unset( $wcvendors_settings_fields_general['shop_description'] ); }
							}
					...
					<?php if ( apply_filters( 'wcfm_is_allow_brand_settings', true ) ) { ?>
						...
						<div class="wcfm-container">
							<div id="wcfm_settings_form_identity_expander" class="wcfm-content">
								...
								if ( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
									$settings_fields_identity = apply_filters(
										'wcfm_wcvendors_settings_fields_identity',
										array(
											'banner' => array(
												'label'   => __( 'Banner', 'wc-frontend-manager' ),
												'type'    => 'upload',
												'class'   => 'wcfm-text wcfm-banner-uploads wcfm_ele',
												'label_class' => 'wcfm_title',
												'prwidth' => 250,
												'value'   => $banner_image_url,
											),
											'_wcv_company_url' => array(
												'label' => __( 'Store Website / Blog URL', 'wc-frontend-manager' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $_wcv_company_url,
												'hints' => __( 'Your company/blog URL here.', 'wc-frontend-manager' ),
											),
											'_wcv_store_phone' => array(
												...
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $_wcv_store_phone,
												'hints' => __( 'This is your store contact number.', 'wc-frontend-manager' ),
											),
										),
										$user_id
									);
									...
									if ( ! apply_filters( 'wcfm_is_allow_store_banner', true ) ) {
										if ( isset( $settings_fields_identity['banner'] ) ) {
											unset( $settings_fields_identity['banner'] ); }
									}

									if ( ! apply_filters( 'wcfm_is_allow_store_phone', true ) ) {
										if ( isset( $settings_fields_identity['_wcv_store_phone'] ) ) {
											unset( $settings_fields_identity['_wcv_store_phone'] ); }
									}
										...
										<div class="store_address">
											<?php
												$WCFM->wcfm_fields->wcfm_generate_form_field(
													apply_filters(
														'wcfm_wcvendors_settings_fields_address',
														array(
															'addr_1' => array(
				...
				<?php if ( $wcfm_is_allow_billing_settings = apply_filters( 'wcfm_is_allow_billing_settings', true ) ) { ?>
					...
					<div class="wcfm-container">
						<div id="wcfm_settings_form_payment_expander" class="wcfm-content">
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_wcvendors_settings_fields_billing',
									array(
										'paypal' => array(
											...
											'label_class' => 'wcfm_title wcfm_ele',
											'value'       => $paypal,
											'hints'       => __( 'Your PayPal address is used to send you your commission.', 'wc-frontend-manager' ),
										),
									),
									$user_id
								)
							...
							if ( apply_filters( 'wcfm_is_allow_billing_bank_settings', true ) && apply_filters( 'wcvendors_vendor_dashboard_bank_details_enable', true ) ) {
								$WCFM->wcfm_fields->wcfm_generate_form_field(
									apply_filters(
										'wcfm_wcvendors_settings_fields_billing_bank',
										array(
											'wcv_bank_account_name' => array(
												'label' => __( 'Account Name', 'wc-vendors' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $wcv_bank_account_name,
											),
											'wcv_bank_account_number' => array(
												'label' => __( 'Account Number', 'wc-vendors' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $wcv_bank_account_number,
											),
											'wcv_bank_name' => array(
											...
											'wcv_bank_routing_number' => array(
												'label' => __( 'Routing Number', 'wc-vendors' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $wcv_bank_routing_number,
											),
											'wcv_bank_iban' => array(
												'label' => __( 'IBAN', 'wc-vendors' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $wcv_bank_iban,
											),
											'wcv_bank_bic_swift' => array(
												'label' => __( 'BIC / Swift', 'wc-vendors' ),
												'type'  => 'text',
												'class' => 'wcfm-text wcfm_ele',
												'label_class' => 'wcfm_title wcfm_ele',
												'value' => $wcv_bank_bic_swift,
											),
										),
										$user_id
									)
							...
							if ( apply_filters( 'wcfm_is_allow_billing_mangopay_settings', true ) ) {
								if ( WCFM_Dependencies::wcfm_wc_mangopay_plugin_active_check() ) {
									...
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										apply_filters(
											'wcfm_wcvendors_settings_fields_billing_mangopay',
											array(
												'vendor_account_type' => array(
													'label' => __( 'Account Type', 'wc-frontend-manager' ),
													'type' => 'select',
													'options' => $account_types,
													'class' => 'wcfm-select wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_type,
												),

												'vendor_iban' => array(
													'label' => __( 'IBAN', 'mangopay' ),
													'type' => 'text',
													'placeholder' => '____ ____ ____ ____ ____',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_IBAN',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_IBAN',
													'value' => $vendor_iban,
												),
												'vendor_bic'  => array(
													'label' => __( 'BIC', 'mangopay' ),
													'type' => 'text',
												...
												'vendor_gb_accountnumber' => array(
													'label' => __( 'Account Number', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_GB',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_GB',
													'value' => $vendor_gb_accountnumber,
												),
												'vendor_gb_sortcode' => array(
													'label' => __( 'Sort Code', 'mangopay' ),
													'type' => 'text',
													'placeholder' => '______',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_GB',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_GB',
													'value' => $vendor_gb_sortcode,
												),
												...
												'vendor_us_accountnumber' => array(
													...
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_US',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_US',
													'value' => $vendor_us_accountnumber,
												),
												'vendor_us_aba' => array(
													'label' => __( 'ABA', 'mangopay' ),
													'type' => 'text',
												...
												'vendor_us_datype' => array(
													'label' => __( 'Deposit Account Type', 'mangopay' ),
													'type' => 'select',
													'custom_attributes' => array( 'required' => 1 ),
													'options' => array(
														'CHECKING' => __( 'CHECKING', 'wc-frontend-manager' ),
														'SAVINGS'  => __( 'SAVINGS', 'wc-frontend-manager' ),
													),
													'class' => 'wcfm-select wcfm_ele mangopay_acc_type mangopay_acc_type_US',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_US',
													'value' => $vendor_us_datype,
												),

												'vendor_ca_bankname' => array(
													'label' => __( 'Bank Name', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'value' => $vendor_ca_bankname,
												),
												'vendor_ca_instnumber' => array(
													'label' => __( 'Institution Number', 'mangopay' ),
													'type' => 'text',
													'placeholder' => '____',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'value' => $vendor_ca_instnumber,
												),
												'vendor_ca_branchcode' => array(
													'label' => __( 'Branch Code', 'mangopay' ),
													'type' => 'text',
													'placeholder' => '_____',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'value' => $vendor_ca_branchcode,
												),
												'vendor_ca_accountnumber' => array(
													...
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_CA',
													'value' => $vendor_ca_accountnumber,
												),

												'vendor_ot_country' => array(
													'label' => __( 'Country', 'mangopay' ),
													'type' => 'country',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-select wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_ot_country,
												),
												'vendor_ot_bic' => array(
													'label' => __( 'BIC', 'mangopay' ),
													'type' => 'text',
													'placeholder' => '___________',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_OTHER',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_OTHER',
													'value' => $vendor_ot_bic,
												),
												'vendor_ot_accountnumber' => array(
													...
													'class' => 'wcfm-text wcfm_ele mangopay_acc_type mangopay_acc_type_OTHER',
													'label_class' => 'wcfm_title wcfm_ele mangopay_acc_type mangopay_acc_type_OTHER',
													'value' => $vendor_ot_accountnumber,
												),

												'vendor_account_name' => array(
													'label' => __( 'Account holder&apos;s name', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
												...
												'vendor_account_address1' => array(
													'label' => __( 'Account holder&apos;s address', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_address1,
												),
												'vendor_account_address2' => array(
													'label' => __( 'Account holder&apos;s address', 'mangopay' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_address2,
												),
												'vendor_account_city' => array(
													'label' => __( 'Account holder&apos;s city', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_city,
												),
												'vendor_account_postcode' => array(
													'label' => __( 'Account holder&apos;s postal code', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_postcode,
												),
												'vendor_account_country' => array(
													'label' => __( 'Account holder&apos;s country', 'mangopay' ),
													'type' => 'country',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-select wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_country,
												),
												'vendor_account_region' => array(
													'label' => __( 'Account holder&apos;s region', 'mangopay' ),
													'type' => 'text',
													'custom_attributes' => array( 'required' => 1 ),
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $vendor_account_region,
												),
											),
											$user_id
										)
								...
								if ( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
									...
									if ( ! $shipping_disabled ) {
										...
										if ( $shipping_type == 'flat' ) {
											...
											$WCFM->wcfm_fields->wcfm_generate_form_field(
												apply_filters(
													'wcfm_vendors_settings_fields_shipping_national_flat',
													array(
														'national' => array(
															...
															'label_class' => 'wcfm_title wcfm_ele',
															'value' => $national,
															'hints' => __( 'The default shipping fee within your country, this can be overridden on a per product basis.', 'wcvendors-pro' ),
															'attributes' => array(
																'min'  => '0.01',
																'step' => '0.01',
															),
											...
											$WCFM->wcfm_fields->wcfm_generate_form_field(
												apply_filters(
													'wcfm_vendors_settings_fields_shipping_international_flat',
													array(
														'international' => array(
															...
															'label_class' => 'wcfm_title wcfm_ele',
															'value' => $international,
															'hints' => __( 'The default shipping fee outside your country, this can be overridden on a per product basis. ', 'wcvendors-pro' ),
															'attributes' => array(
																'min'  => '0.01',
																'step' => '0.01',
															),
											...
											$WCFM->wcfm_fields->wcfm_generate_form_field(
												apply_filters(
													'wcfm_vendors_settings_fields_shipping_rates',
													array(
														'_wcv_shipping_rates'      => array(
										...
										$WCFM->wcfm_fields->wcfm_generate_form_field(
											apply_filters(
												'wcfm_vendors_settings_fields_shipping',
												array(
													'min_charge' => array(
														'label' => __( 'Min Charge Order', 'wc-frontend-manager' ),
														'placeholder' => '0',
														'type' => 'number',
														'class' => 'wcfm-text wcfm_ele',
														'label_class' => 'wcfm_title wcfm_ele',
														'value' => $min_charge,
														'hints' => __( 'The minimum shipping fee charged for an order.', 'wc-frontend-manager' ),
														'attributes' => array(
															'min'  => '0.01',
															'step' => '0.01',
														),
													...
													'max_charge' => array(
														'label' => __( 'Max Charge Order', 'wc-frontend-manager' ),
														'placeholder' => '0',
														'type' => 'number',
														'class' => 'wcfm-text wcfm_ele',
														'label_class' => 'wcfm_title wcfm_ele',
														'value' => $max_charge,
														'hints' => __( 'The maximum shipping fee charged for an order.', 'wc-frontend-manager' ),
														'attributes' => array(
															'min'  => '0.01',
															'step' => '0.01',
														),
													...
													'free_shipping_order' => array(
														'label' => __( 'Free Shipping Order', 'wc-frontend-manager' ),
														'placeholder' => '0',
														'type' => 'number',
														'class' => 'wcfm-text wcfm_ele',
														'label_class' => 'wcfm_title wcfm_ele',
														'value' => $free_shipping_order,
														'hints' => __( 'Free shipping for order spends over this amount. This will override the max shipping charge above.', 'wc-frontend-manager' ),
														'attributes' => array(
															'min'  => '0.01',
															'step' => '0.01',
														),
									...
									<div class="store_address">
										<?php
											$WCFM->wcfm_fields->wcfm_generate_form_field(
												apply_filters(
													'wcfm_wcvendors_settings_fields_shipping_address',
													array(
														'saddr_1' => array(
															'label' => __( 'Address 1', 'wc-frontend-manager' ),
															'type' => 'text',
									...
									<?php
								} elseif ( $is_wcfmu_inactive_notice_show = apply_filters( 'is_wcfmu_inactive_notice_show', true ) ) {
										wcfmu_feature_help_text_show( __( 'WCV Pro Settings', 'wc-frontend-manager' ) );
								}
								?>
							</div>
