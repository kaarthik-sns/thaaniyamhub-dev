...
$template_options = apply_filters(
	'wcmp_vendor_shop_template_options',
	array(
		'template1' => $WCMp->plugin_url . 'assets/images/template1.png',
		'template2' => $WCMp->plugin_url . 'assets/images/template2.png',
		'template3' => $WCMp->plugin_url . 'assets/images/template3.png',
	)
);
					...
					<div id="wcfm_settings_form_vendor_expander" class="wcfm-content">
						<?php
							$settings_fields_general = apply_filters(
								'wcfm_wcmarketplace_settings_fields_general',
								array(
									'wcfm_logo'        => array(
										...
										'hints'       => __( 'Preferred logo should be 200x200 px.', 'wc-frontend-manager' ),
									),
									'shop_name'        => array(
									...
									'shop_slug'        => array(
										'label'       => __( 'Shop Slug', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele',
										'label_class' => 'wcfm_title wcfm_ele',
										'value'       => $vendor->page_slug,
										'hints'       => __( 'Your shop slug is public and must be unique.', 'wc-frontend-manager' ),
									),
							...
							if ( ! apply_filters( 'wcfm_is_allow_store_logo', true ) ) {
								if ( isset( $settings_fields_general['wcfm_logo'] ) ) {
									unset( $settings_fields_general['wcfm_logo'] ); }
							}

							if ( ! apply_filters( 'wcfm_is_allow_store_name', true ) ) {
								if ( isset( $settings_fields_general['shop_name'] ) ) {
									unset( $settings_fields_general['shop_name'] ); }
								if ( isset( $settings_fields_general['shop_slug'] ) ) {
									unset( $settings_fields_general['shop_slug'] ); }
							}
					...
					<div class="wcfm-container">
						<div id="wcfm_settings_form_identity_expander" class="wcfm-content">
							...
							$settings_fields_identity = apply_filters(
								'wcfm_wcmarketplace_settings_fields_identity',
								array(
									'banner'     => array(
										...
										'hints'       => __( 'Preferred banner should be 1200x245 px.', 'wc-frontend-manager' ),
									),
									 
									'shop_phone' => array(
										'label'       => __( 'Shop Phone', 'wc-frontend-manager' ),
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele',
										'label_class' => 'wcfm_title wcfm_ele',
										'value'       => $shop_phone,
										'hints'       => __( 'Your store phone no.', 'wc-frontend-manager' ),
									),
								),
								$user_id
							);
							...
							if ( ! apply_filters( 'wcfm_is_allow_store_phone', true ) ) {
								if ( isset( $settings_fields_identity['shop_phone'] ) ) {
									unset( $settings_fields_identity['shop_phone'] ); }
							}
								...
								<div class="store_address">
									<?php
										$WCFM->wcfm_fields->wcfm_generate_form_field(
											apply_filters(
												'wcfm_wcmarketplace_settings_fields_address',
												array(
													'addr_1' => array(
							...
							<?php if ( apply_filters( 'wcfm_is_allow_store_address', true ) ) { ?>
								...
								<div class="store_address store_location_wrap">
									...
									if ( ! empty( $api_key ) ) {
										$WCFM->wcfm_fields->wcfm_generate_form_field(
											apply_filters(
												'wcfm_wcmarketplace_settings_fields_location',
												array(
													'find_address' => array(
				...
				<?php if ( $wcfm_is_allow_billing_settings = apply_filters( 'wcfm_is_allow_billing_settings', true ) ) { ?>
					...
					<div class="wcfm-container">
						<div id="wcfm_settings_form_payment_expander" class="wcfm-content">
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters(
									'wcfm_wcmarketplace_settings_fields_billing',
									array(
										'_vendor_payment_mode' => array(
											'label'       => __( 'Payment Method', 'dc-woocommerce-multi-vendor' ),
											'type'        => 'select',
											'options'     => $wcfm_vendor_payment_modes,
											'class'       => 'wcfm-select wcfm_ele',
											'label_class' => 'wcfm_title wcfm_ele',
											'value'       => $_vendor_payment_mode,
										),
										'paypal_email' => array(
											'label'       => __( 'PayPal Email', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_paypal_payout paymode_paypal_masspay paymode_paypal_adaptive',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_paypal_payout paymode_paypal_masspay paymode_paypal_adaptive',
											'value'       => $paypal_email,
										),
										'_vendor_bank_account_type' => array(
											'label'       => __( 'Account Type', 'wc-frontend-manager' ),
											'type'        => 'select',
											'options'     => array(
												'current' => __( 'Current', 'wc-frontend-manager' ),
												'savings' => __( 'Savings', 'wc-frontend-manager' ),
											),
											'class'       => 'wcfm-select wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_bank_account_type,
										),
										'_vendor_bank_account_number' => array(
											'label'       => __( 'Account Number', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_bank_account_number,
										),
										'_vendor_bank_name' => array(
											'label'       => __( 'Bank Name', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_bank_name,
										),
										'_vendor_aba_routing_number' => array(
											'label'       => __( 'ABA Routing Number', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_aba_routing_number,
										),
										'_vendor_bank_address' => array(
											'label'       => __( 'Bank Address', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_bank_address,
										),
										'_vendor_destination_currency' => array(
											'label'       => __( 'Destination Currency', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_destination_currency,
										),
										'_vendor_iban' => array(
											'label'       => __( 'Account IBAN', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_iban,
										),
										'_vendor_account_holder_name' => array(
											'label'       => __( 'Account Holder Name', 'wc-frontend-manager' ),
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele paymode_field paymode_direct_bank',
											'label_class' => 'wcfm_title wcfm_ele paymode_field paymode_direct_bank',
											'value'       => $_vendor_account_holder_name,
										),
									),
									$user_id
								)
									...
									foreach ( $raw_methods as $raw_method ) {
										if ( $raw_method->id == 'flat_rate' && isset( $raw_method->instance_form_fields[ 'class_cost_' . $shipping_class_id ] ) ) {
											...
											$WCFM->wcfm_fields->wcfm_generate_form_field(
												array(
													$option_name => array(
														'label' => $instance_field['title'] . ' - ' . $raw_method->title,
														'name' => 'wcfm_vendor_shipping_data[' . $option_name . ']',
														'placeholder' => $instance_field['placeholder'],
														'type' => 'number',
														'class' => 'wcfm-text wcfm_ele',
														'label_class' => 'wcfm_title wcfm_ele',
														'value' => esc_attr( $instance_settings ),
														'hints' => strip_tags( $instance_field['description'] ),
														'attributes' => array(
															'min'  => '0.01',
															'step' => '0.01',
														),
											...
											if ( WCFM_Dependencies::wcfm_wc_table_rates_active_check() && WCFM_Dependencies::wcfm_wcmp_advanced_shipping_active_check() ) {
												...
												if ( ! empty( $table_rates ) ) {
													foreach ( $table_rates as $table_rate ) {
														$table_rate_shipping_rules[] = array(
															'rate_condition' => esc_attr( $table_rate->rate_condition ),
												...
												$table_rate_shipping_fields = array(
													'wcfm_table_rate_shipping_rules'  => array(
														'label' => __( 'Shipping Rules', 'wc-frontend-manager' ),
														'type'    => 'multiinput',
														'name'    => 'wcfm_table_rate_shipping_rules[' . $raw_method->instance_id . ']',
														'class'   => 'wcfm-text',
														'label_class' => 'wcfm_title',
														'value'   => $table_rate_shipping_rules,
														'options' => array(
															'rate_condition' => array(
																'label' => __( 'Condition', 'wcmp-advance-shipping' ),
																'type' => 'select',
																'options' => array(
																	'' => __( 'None', 'wcmp-advance-shipping' ),
																	'price' => __( 'Price', 'wcmp-advance-shipping' ),
																	'weight' => __( 'Weight', 'wcmp-advance-shipping' ),
																	'items' => __( 'Item count', 'wcmp-advance-shipping' ),
																),
																'class' => 'wcfm-select wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
															),
															'rate_label' => array(
																'label' => __( 'Label', 'wcmp-advance-shipping' ),
																'type' => 'text',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
															),
															'rate_min' => array(
																'label' => __( 'Min', 'wcmp-advance-shipping' ),
																'type' => 'number',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
																'attributes' => array(
															...
															'rate_max' => array(
																'label' => __( 'Max', 'wcmp-advance-shipping' ),
																'type' => 'number',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
																'attributes' => array(
															...
															'rate_cost' => array(
																'label' => __( 'Row cost', 'wcmp-advance-shipping' ),
																'type' => 'number',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
																'attributes' => array(
															...
															'rate_cost_per_item' => array(
																'label' => __( 'Item cost', 'wcmp-advance-shipping' ),
																'type' => 'number',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
																'attributes' => array(
															...
															'rate_cost_per_weight_unit' => array(
																'label' => __( 'lbs cost', 'wcmp-advance-shipping' ),
																'type' => 'number',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
																'attributes' => array(
															...
															'rate_cost_percent' => array(
																'label' => __( '% cost', 'wcmp-advance-shipping' ),
																'type' => 'number',
																'class' => 'wcfm-text wcfm_half_ele',
																'label_class' => 'wcfm_title wcfm_half_ele_title',
																'attributes' => array(
