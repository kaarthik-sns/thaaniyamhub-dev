					...
					<div id="wcfm_settings_form_store_expander" class="wcfm-content">
						<?php
							$settings_fields_general = apply_filters(
								'wcfm_dokan_settings_fields_general',
								array(
									'gravatar'       => array(
										'label'       => __( 'Profile Image', 'wc-frontend-manager' ),
										'type'        => 'upload',
									...
									'store_ppp'      => array(
										'label'       => __( 'Store Product Per Page', 'wc-frontend-manager' ),
										'type'        => 'number',
										'placeholder' => '10',
										'class'       => 'wcfm-text wcfm_ele',
										'label_class' => 'wcfm_title wcfm_ele',
									...
									'show_email'     => array(
										'label'       => __( 'Show email in store', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
									...
									'show_more_ptab' => array(
										'label'       => __( 'Show tab on product single page view', 'wc-frontend-manager' ),
										'type'        => 'checkbox',
										'class'       => 'wcfm-checkbox wcfm_ele',
										'label_class' => 'wcfm_title checkbox_title wcfm_ele',
										'value'       => 'yes',
										'dfvalue'     => $show_more_ptab,
									),
								)
							);
							...
							<div class="store_address">
								<?php
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										apply_filters(
											'wcfm_dokan_settings_fields_address',
											array(
												'street_1' => array(
							...
							<div class="store_address">
								<?php
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										apply_filters(
											'wcfm_dokan_settings_fields_location',
											array(
												'find_address' => array(
													'label' => __( 'Find Address', 'dokan-lite' ),
													'placeholder' => __( 'Type an address to find', 'dokan-lite' ),
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $map_address,
							...
							<div class="store_address">
								<?php
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										apply_filters(
											'wcfm_dokan_settings_fields_terms',
											array(
												'enable_tnc' => array(
													'label' => __( 'Show terms and conditions in store page', 'dokan-lite' ),
													'type' => 'checkbox',
													'class' => 'wcfm-checkbox wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => 'on',
												...
												'store_tnc'  => array(
													'label' => __( 'TOC Details', 'dokan-lite' ),
													'type' => 'textarea',
				...
				<?php if ( $wcfm_is_allow_billing_settings = apply_filters( 'wcfm_is_allow_billing_settings', true ) ) { ?>
					...
					<div class="wcfm-container">
						<div id="wcfm_settings_form_payment_expander" class="wcfm-content">
							...
							$dokan_settings_fields_billing = apply_filters(
								'wcfm_dokan_settings_fields_billing',
								array(
									'paypal'     => array(
									...
									'woo_wallet' => array(
										'label'       => __( 'Wallet', 'wc-frontend-manager' ),
										'placeholder' => __( 'Wallet Credit', 'wc-frontend-manager' ),
										'name'        => 'payment[wallet][email]',
										'type'        => 'text',
										'class'       => 'wcfm-text wcfm_ele',
										'label_class' => 'wcfm_title wcfm_ele',
							...
							if ( ! in_array( 'paypal', $dokan_withdraw_methods ) ) {
								unset( $dokan_settings_fields_billing['paypal'] );
							}
							if ( ! in_array( 'skrill', $dokan_withdraw_methods ) ) {
								unset( $dokan_settings_fields_billing['skrill'] );
							}
							...
							<?php if ( in_array( 'bank', $dokan_withdraw_methods ) ) { ?>
								...
								<div class="store_address">
									<?php
										$WCFM->wcfm_fields->wcfm_generate_form_field(
											apply_filters(
												'wcfm_dokan_settings_fields_billing_bank',
												array(
													'ac_name' => array(
													...
													'ac_number' => array(
														...
														'placeholder' => __( 'Your bank account number', 'dokan-lite' ),
								...
								if ( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
									if ( ! current_user_can( 'dokan_view_store_shipping_menu' ) ) {
										...
										if ( 'disabled' == $disable_woo_shipping ) {
											...
											if ( $wcfm_dokan_regular_shipping == 'yes' ) {
												$wcfm_dokan_regular_shipping = 'checked';
											}

											if ( 'yes' == $enable_shipping ) {
												if ( version_compare( DOKAN_PRO_PLUGIN_VERSION, '2.8.0', '>' ) ) {
													printf(
														'<p>%s&nbsp;&nbsp;<input type="checkbox" class="wcfm-checkbox" name="wcfm_dokan_regular_shipping" style="margin-right: 5px;" value="yes" %s /></p><br />',
											...
											if ( 'no' == $enable_shipping ) {
												...
												$WCFM->wcfm_fields->wcfm_generate_form_field(
													apply_filters(
														...
														array(
															'dps_shipping_enable' => array(
																'label' => __( 'Enable Shipping', 'wc-frontend-manager' ),
																'name' => 'shipping[_dps_shipping_enable]',
																'type' => 'checkbox',
																'class' => 'wcfm-checkbox wcfm_ele',
																'label_class' => 'wcfm_title checkbox_title wcfm_ele',
																'value' => 'yes',
																'dfvalue' => $dps_shipping_enable,
																'hints' => __( 'Check this if you want to enable shipping for your store', 'dokan' ),
															),
															'dps_shipping_type_price' => array(
																'label' => __( 'Default Shipping Price', 'dokan' ),
																'name' => 'shipping[_dps_shipping_type_price]',
																'placeholder' => '0.00',
																'type' => 'number',
																'class' => 'wcfm-text wcfm_ele',
																'label_class' => 'wcfm_title wcfm_ele',
																'value' => $dps_shipping_type_price,
																'hints' => __( 'This is the base price and will be the starting shipping price for each product', 'dokan' ),
																'attributes' => array(
																	'min' => '0.01',
																	'step' => '0.01',
																),
															),
															'dps_additional_product' => array(
																'label' => __( 'Per Product Additional Price', 'dokan' ),
																'name' => 'shipping[_dps_additional_product]',
																'placeholder' => '0.00',
																'type' => 'number',
																'class' => 'wcfm-text wcfm_ele',
																'label_class' => 'wcfm_title wcfm_ele',
																'value' => $dps_additional_product,
															...
															'dps_additional_qty' => array(
																'label' => __( 'Per Qty Additional Price', 'dokan' ),
																'name' => 'shipping[_dps_additional_qty]',
																'placeholder' => '0.00',
																'type' => 'number',
																'class' => 'wcfm-text wcfm_ele',
																'label_class' => 'wcfm_title wcfm_ele',
																'value' => $dps_additional_qty,
															...
															'dps_form_location' => array(
																'label' => __( 'Ships from:', 'dokan' ),
																'name' => 'shipping[_dps_form_location]',
																'type' => 'country',
																'class' => 'wcfm-select wcfm_ele',
																'label_class' => 'wcfm_title wcfm_ele',
																'value' => $dps_form_location,
																'hints' => __( 'Location from where the products are shipped for delivery. Usually it is same as the store.', 'dokan' ),
															),
													...
													foreach ( $dps_country_rates as $country => $country_rate ) {
														...
														if ( ! empty( $dps_state_rates ) && isset( $dps_state_rates[ $country ] ) ) {
															foreach ( $dps_state_rates[ $country ] as $state => $state_rate ) {
																...
																$dps_shipping_state_rates[] = array(
																	'dps_state_to' => $state,
																	'dps_state_to_price' => $state_rate,
																	'option_values' => $state_options,
																);
															}
														}
														$dps_shipping_rates[] = array(
															'dps_country_to' => $country,
															'dps_country_to_price' => $country_rate,
															'dps_shipping_state_rates' => $dps_shipping_state_rates,
														);
													}
												}
												$WCFM->wcfm_fields->wcfm_generate_form_field(
													apply_filters(
														...
														array(
															'dps_shipping_rates' => array(
																...
																'type' => 'multiinput',
																'label_class' => 'wcfm_title',
																'value' => $dps_shipping_rates,
																'desc' => __( 'Add the countries you deliver your products to. You can specify states as well. If the shipping price is same except some countries/states, there is an option Everywhere Else, you can use that.', 'wc-frontend-manager' ),
																'options' => array(
																	'dps_country_to' => array(
																		'label' => __( 'Country', 'wc-frontend-manager' ),
																		'type' => 'country',
																		'class' => 'wcfm-select dps_country_to_select',
																		'label_class' => 'wcfm_title',
																		'dokan_shipping_country' => true,
																	),
																	'dps_country_to_price' => array(
																		'label' => __( 'Cost', 'wc-frontend-manager' ) . '(' . get_woocommerce_currency_symbol() . ')',
																		'type' => 'number',
																		'class' => 'wcfm-text',
																		'label_class' => 'wcfm_title',
																		'attributes' => array(
																	...
																	'dps_shipping_state_rates' => array(
																		'label' => __( 'State Shipping Rates', 'wc-frontend-manager' ),
																		'type' => 'multiinput',
																		'label_class' => 'wcfm_title dps_shipping_state_rates_label',
																		'options' => array(
																			'dps_state_to' => array(
																				'label' => __( 'State', 'wc-frontend-manager' ),
																				'type' => 'select',
																				'class' => 'wcfm-select dps_state_to_select',
																				'label_class' => 'wcfm_title',
																				'options' => $state_options,
																			),
																			'dps_state_to_price' => array(
																				'label' => __( 'Cost', 'wc-frontend-manager' ) . '(' . get_woocommerce_currency_symbol() . ')',
																				'type' => 'number',
																				'class' => 'wcfm-text',
																				'label_class' => 'wcfm_title',
								...
								if ( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
									$WCFM->wcfm_fields->wcfm_generate_form_field(
										apply_filters(
											'wcfm_vendors_settings_fields_shipping',
											array(
												'dokan-seo-meta-title' => array(
													'label' => __( 'SEO Title', 'dokan' ),
													'name' => 'store_seo[dokan-seo-meta-title]',
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_meta_title,
													'hints' => __( 'SEO Title is shown as the title of your store page', 'dokan' ),
												),
												'dokan-seo-meta-desc' => array(
													'label' => __( 'Meta Description', 'dokan' ),
													'name' => 'store_seo[dokan-seo-meta-desc]',
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_meta_desc,
													'hints' => __( 'The meta description is often shown as the black text under the title in a search result. For this to work it has to contain the keyword that was searched for and should be less than 156 chars.', 'dokan' ),
												),
												'dokan-seo-meta-keywords' => array(
													'label' => __( 'Meta Keywords', 'dokan' ),
													'name' => 'store_seo[dokan-seo-meta-keywords]',
													'type' => 'textarea',
													'class' => 'wcfm-textarea wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_meta_keywords,
													'hints' => __( 'Insert some comma separated keywords for better ranking of your store page.', 'dokan' ),
												),
												'dokan-seo-og-title' => array(
													'label' => __( 'Facebook Title', 'dokan' ),
													'name' => 'store_seo[dokan-seo-og-title]',
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_og_title,
												),
												'dokan-seo-og-desc' => array(
													'label' => __( 'Facebook Description', 'dokan' ),
													'name' => 'store_seo[dokan-seo-og-desc]',
													'type' => 'textarea',
													'class' => 'wcfm-textarea wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_og_desc,
												),
												'dokan-seo-og-image' => array(
													'label' => __( 'Facebook Image', 'dokan' ),
													'name' => 'store_seo[dokan-seo-og-image]',
													'type' => 'upload',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_og_image_url,
												),
												'dokan-seo-twitter-title' => array(
													'label' => __( 'Twitter Title', 'dokan' ),
													'name' => 'store_seo[dokan-seo-twitter-title]',
													'type' => 'text',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_twitter_title,
												),
												'dokan-seo-twitter-desc' => array(
													'label' => __( 'Twitter Description', 'dokan' ),
													'name' => 'store_seo[dokan-seo-twitter-desc]',
													'type' => 'textarea',
													'class' => 'wcfm-textarea wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_twitter_desc,
												),
												'dokan-seo-twitter-image' => array(
													'label' => __( 'Twitter Image', 'dokan' ),
													'name' => 'store_seo[dokan-seo-twitter-image]',
													'type' => 'upload',
													'class' => 'wcfm-text wcfm_ele',
													'label_class' => 'wcfm_title wcfm_ele',
													'value' => $dokan_seo_twitter_image_url,
												),
											)
										)
									);
