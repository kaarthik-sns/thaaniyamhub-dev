...
<div class="collapse wcfm-collapse" id="wcfm_product_popup_container">
	<div class="wcfm-collapse-content">
		...
		<form id="wcfm_products_manage_form" class="wcfm">
								...
								apply_filters(
									...
									array(
										'product_type'    => array(
											...
											'class'       => 'wcfm-select wcfm_ele wcfm_product_type wcfm_full_ele simple variable external grouped booking ' . $product_type_class,
										...
										'is_virtual'      => array(
											...
											'desc_class' => 'wcfm_title wcfm_ele virtual_ele_title checkbox_title simple booking non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking non-pw-gift-card',
											'value'      => 'enable',
											'dfvalue'    => $is_virtual,
										),
										'is_downloadable' => array(
											...
											'type'       => 'checkbox',
											'class'      => 'wcfm-checkbox wcfm_ele wcfm_half_ele_checkbox simple booking appointment non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking non-pw-gift-card',
											'desc_class' => 'wcfm_title wcfm_ele downloadable_ele_title checkbox_title simple appointment booking non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking non-pw-gift-card',
											'value'      => 'enable',
								...
								apply_filters(
									...
									array(
										'product_url'    => array(
											...
											'type'        => 'text',
											'class'       => 'wcfm-text wcfm_ele external',
											'label_class' => 'wcfm_ele wcfm_title external',
											'value'       => $product_url,
										...
										'regular_price'  => array(
											...
											'type'        => 'number',
											'class'       => 'wcfm-text wcfm_ele wcfm_non_negative_input simple external non-subscription non-variable-subscription non-auction non-redq_rental non-accommodation-booking non-lottery non-pw-gift-card',
										...
										'sale_price'     => array(
											...
											'type'        => 'number',
											'class'       => 'wcfm-text wcfm_ele wcfm_non_negative_input simple external non-variable-subscription non-auction non-redq_rental non-accommodation-booking non-lottery non-pw-gift-card',
											...
											'value'       => $sale_price,
											'desc_class'  => 'wcfm_ele simple external non-variable-subscription non-auction non-redq_rental non-accommodation-booking non-lottery sales_schedule non-pw-gift-card',
										...
										'sale_date_from' => array(
											...
											'class'       => 'wcfm-text wcfm_ele sales_schedule_ele simple external non-variable-subscription non-auction non-redq_rental non-accommodation-booking',
											'label_class' => 'wcfm_ele sales_schedule_ele wcfm_title simple external non-variable-subscription non-auction non-redq_rental non-accommodation-booking',
			...
			<?php require $WCFM->library->views_path . 'products-manager/wcfm-view-products-manage-tabs.php'; ?>
