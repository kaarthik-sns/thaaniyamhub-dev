...
class WCFM_Settings_WCPVendors_Controller {
	...
	public function processing() {
		...
		if ( apply_filters( 'wcfm_is_allow_store_description', true ) ) {
			$wcfm_settings_form['profile'] = ! empty( $_POST['profile'] ) ? wp_filter_post_kses( apply_filters( 'wcfm_editor_content_before_save', stripslashes( html_entity_decode( $_POST['profile'], ENT_QUOTES, 'UTF-8' ) ) ) ) : '';
		}
