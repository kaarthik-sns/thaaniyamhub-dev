...
class WCFM_WCBookings_Controller {
	...
	public function processing() {
		...
		if ( isset( $_POST['booking_status'] ) && ! empty( $_POST['booking_status'] ) && ( $_POST['booking_status'] != 'all' ) ) {
			$args['post_status'] = wc_clean( $_POST['booking_status'] ); }
		...
		if ( isset( $_POST['booking_filter'] ) && ! empty( $_POST['booking_filter'] ) ) {
			$args['meta_key']   = '_booking_product_id';
			$args['meta_value'] = wc_clean( $_POST['booking_filter'] );
		}
