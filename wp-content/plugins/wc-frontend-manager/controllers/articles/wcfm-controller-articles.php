...
class WCFM_Articles_Controller {
	...
	public function processing() {
		...
		if ( isset( $_POST['article_status'] ) && ! empty( $_POST['article_status'] ) ) {
			$args['post_status'] = wc_clean( $_POST['article_status'] );
		}
		...
		if ( ! empty( $wcfm_articles_array ) ) {
			...
			foreach ( $wcfm_articles_array as $wcfm_articles_single ) {
				...
				} elseif ( $wcfm_articles_single->post_status == 'publish' ) {
		...
		if ( ! empty( $wcfm_articles_json_arr ) ) {
			$wcfm_articles_json .= json_encode( $wcfm_articles_json_arr );
		} else {
			$wcfm_articles_json .= '[]';
		}
		$wcfm_articles_json .= '
