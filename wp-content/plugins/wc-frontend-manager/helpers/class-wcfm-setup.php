...
class WCFM_Dashboard_Setup {
		...
		<form method="post">
			<table class="form-table">
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_settings_fields_style',
						array(
							'dashboard_full_view_disabled' => array(
								'label'       => __( 'WCFM Full View', 'wc-frontend-manager' ),
								'name'        => 'dashboard_full_view_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_dashboard_full_view_disabled,
							),
							'dashboard_theme_header_disabled' => array(
								'label'       => __( 'Theme Header', 'wc-frontend-manager' ),
								'name'        => 'dashboard_theme_header_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_dashboard_theme_header_disabled,
							),
							'slick_menu_disabled'          => array(
								'label'       => __( 'WCFM Slick Menu', 'wc-frontend-manager' ),
								'name'        => 'slick_menu_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_slick_menu_disabled,
							),
							'headpanel_disabled'           => array(
								'label'       => __( 'WCFM Header Panel', 'wc-frontend-manager' ),
								'name'        => 'headpanel_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_headpanel_disabled,
							),
							'welcome_box_disabled'         => array(
								'label'       => __( 'Welcome Box', 'wc-frontend-manager' ),
								'name'        => 'welcome_box_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_welcome_box_disabled,
							),
							'checklist_view_disabled'      => array(
								'label'       => __( 'Category Checklist View', 'wc-frontend-manager' ),
								'name'        => 'checklist_view_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_checklist_view_disabled,
								'hints'       => __( 'Disable this to have Product Manager Category/Custom Taxonomy Selector - Flat View.', 'wc-frontend-manager' ),
							),
							'quick_access_disabled'        => array(
								'label'       => __( 'Quick Access', 'wc-frontend-manager' ),
								'name'        => 'quick_access_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_quick_access_disabled,
							),
							 
							'float_button_disabled'        => array(
								'label'       => __( 'Float Button', 'wc-frontend-manager' ),
								'name'        => 'float_button_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_float_button_disabled,
							),
						)
					)
				);
	...
	public function wcfm_setup_marketplace() {
		...
		$multivendor_plugins = array(
			'dokan'         => 'Dokan Mutivendor',
			'wcmarketplace' => 'WC Marketplace',
			'wcvendors'     => 'WC Vendors',
			'wcpvendors'    => 'WC Product Vendors',
		);
		?>
		<?php if ( ! $is_marketplace || ( $is_marketplace != 'wcfmmarketplace' ) ) { ?>
			<style>
		...
		<?php } else { ?>
			...
			<form method="post">
				<table class="form-table">
					...
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_marketplace_settings_fields_store',
							array(
								'vendor_store_url'        => array(
									'label'       => __( 'Store URL Base', 'wc-multivendor-marketplace' ),
									'type'        => 'text',
									'class'       => 'wcfm-text wcfm_ele',
									'label_class' => 'wcfm_title wcfm_ele',
									'in_table'    => 'yes',
									'desc_class'  => 'wcfm_page_options_desc',
									'value'       => $wcfm_store_url,
									'desc'        => sprintf( __( 'Define the seller store URL  (%s/[this-text]/[seller-name])', 'wc-multivendor-marketplace' ), get_site_url() ),
								),
								'vendor_sold_by'          => array(
									'label'       => __( 'Visible Sold By', 'wc-multivendor-marketplace' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
									'label_class' => 'wcfm_title checkbox_title',
									'value'       => 'yes',
									'dfvalue'     => $vendor_sold_by,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Uncheck this to disable Sold By display for products.', 'wc-multivendor-marketplace' ),
								),
								'vendor_sold_by_template' => array(
									'label'       => __( 'Sold By Template', 'wc-multivendor-marketplace' ),
									'type'        => 'select',
									'in_table'    => 'yes',
									'options'     => array(
										'simple'   => __( 'Simple', 'wc-multivendor-marketplace' ),
										'advanced' => __( 'Advanced', 'wc-multivendor-marketplace' ),
										'tab'      => __( 'As Tab', 'wc-multivendor-marketplace' ),
									),
									'class'       => 'wcfm-select wcfm_ele',
									'label_class' => 'wcfm_title',
									'value'       => $vendor_sold_by_template,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Single product page Sold By template.', 'wc-multivendor-marketplace' ),
								),
								'sold_by_template_simple' => array(
									'label'         => '&nbsp;',
									'type'          => 'html',
									'in_table'      => 'yes',
									'wrapper_class' => 'vendor_sold_by_type vendor_sold_by_type_simple',
									'label_class'   => 'wcfm_title wcfm_ele',
									'value'         => '<img src="' . esc_url( $WCFMmp->plugin_url ) . 'assets/images/sold_by_simple.png" />',
									'attributes'    => array( 'style' => 'border: 1px dotted #ccc;margin-bottom:15px;' ),
								),
								'sold_by_template_advanced' => array(
									'label'         => '&nbsp;',
									'type'          => 'html',
									'in_table'      => 'yes',
									'wrapper_class' => 'vendor_sold_by_type vendor_sold_by_type_advanced',
									'label_class'   => 'wcfm_title wcfm_ele',
									'value'         => '<img src="' . esc_url( $WCFMmp->plugin_url ) . 'assets/images/sold_by_advanced.png" />',
									'attributes'    => array( 'style' => 'border: 1px dotted #ccc;margin-bottom:15px;' ),
								),
								'sold_by_template_tab'    => array(
									'label'         => '&nbsp;',
									'type'          => 'html',
									'in_table'      => 'yes',
									'wrapper_class' => 'vendor_sold_by_type vendor_sold_by_type_tab',
									'label_class'   => 'wcfm_title wcfm_ele',
									'value'         => '<img src="' . esc_url( $WCFMmp->plugin_url ) . 'assets/images/sold_by_tab.png" />',
									'attributes'    => array( 'style' => 'border: 1px dotted #ccc;margin-bottom:15px;' ),
								),
								'vendor_sold_by_position' => array(
									'label'       => __( 'Sold By Position', 'wc-multivendor-marketplace' ),
									'type'        => 'select',
									'in_table'    => 'yes',
									'options'     => array(
										'bellow_price' => __( 'Below Price', 'wc-multivendor-marketplace' ),
										'bellow_sc'    => __( 'Below Short Description', 'wc-multivendor-marketplace' ),
										'bellow_atc'   => __( 'Below Add to Cart', 'wc-multivendor-marketplace' ),
									),
									'class'       => 'wcfm-select wcfm_ele',
									'label_class' => 'wcfm_title',
									'value'       => $vendor_sold_by_position,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Sold by display position at Single Product Page.', 'wc-multivendor-marketplace' ),
								),
								'store_name_position'     => array(
									'label'       => __( 'Store Name Position', 'wc-multivendor-marketplace' ),
									'type'        => 'select',
									'in_table'    => 'yes',
									'options'     => array(
										'on_banner' => __( 'On Banner', 'wc-multivendor-marketplace' ),
										'on_header' => __( 'At Header', 'wc-multivendor-marketplace' ),
									),
									'class'       => 'wcfm-select wcfm_ele',
									'label_class' => 'wcfm_title',
									'value'       => $store_name_position,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Store name position at Vendor Store Page.', 'wc-multivendor-marketplace' ),
								),
								'store_sidebar'           => array(
									'label'       => __( 'Store Sidebar', 'wc-multivendor-marketplace' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
									'label_class' => 'wcfm_title checkbox_title',
									'value'       => 'yes',
									'dfvalue'     => $store_sidebar,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Uncheck this to disable vendor store sidebar.', 'wc-multivendor-marketplace' ),
								),
								'store_sidebar_pos'       => array(
									'label'       => __( 'Store Sidebar Position', 'wc-multivendor-marketplace' ),
									'type'        => 'select',
									'in_table'    => 'yes',
									'options'     => array(
										'left'  => __( 'At Left', 'wc-multivendor-marketplace' ),
										'right' => __( 'At Right', 'wc-multivendor-marketplace' ),
									),
									'class'       => 'wcfm-select wcfm_ele',
									'label_class' => 'wcfm_title',
									'value'       => $store_sidebar_pos,
								),
								'store_related_products'  => array(
									'label'       => __( 'Store Related Products', 'wc-multivendor-marketplace' ),
									'type'        => 'select',
									'in_table'    => 'yes',
									'options'     => array(
										'default' => __( 'As per WC Default Rule', 'wc-multivendor-marketplace' ),
										'store'   => __( 'Only same Store Products', 'wc-multivendor-marketplace' ),
									),
									'class'       => 'wcfm-select wcfm_ele',
									'label_class' => 'wcfm_title',
									'value'       => $store_related_products,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Single product page related products rule.', 'wc-frontend-manager' ),
								),
								'store_ppp'               => array(
									'label'       => __( 'Products per page', 'wc-multivendor-marketplace' ),
									'type'        => 'number',
									'in_table'    => 'yes',
									'class'       => 'wcfm-text wcfm_ele',
									'label_class' => 'wcfm_title',
									...
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'No of products at Store per Page.', 'wc-frontend-manager' ),
								),
								 
								 
								'enable_marketplace_shipping' => array(
									'label'       => __( 'Marketplace Shipping', 'wc-multivendor-marketplace' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
									'label_class' => 'wcfm_title checkbox_title',
									'value'       => 'yes',
									'dfvalue'     => $wcfmmp_marketplace_shipping_enabled,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Enable this to allow your vendors to setup their own shipping by country.', 'wc-multivendor-marketplace' ),
								),
								'enable_marketplace_shipping_by_weight' => array(
									'label'       => __( 'Marketplace Shipping by Weight', 'wc-multivendor-marketplace' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
									'label_class' => 'wcfm_title checkbox_title',
									'value'       => 'yes',
									'dfvalue'     => $wcfmmp_marketplace_shipping_by_weight_enabled,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Enable this to allow your vendors to setup their own shipping by weight.', 'wc-multivendor-marketplace' ),
								),
								'wcfm_google_map_api'     => array(
									'label'       => __( 'Google Map API Key', 'wc-multivendor-marketplace' ),
									'type'        => 'text',
									'class'       => 'wcfm-text wcfm_ele',
									'label_class' => 'wcfm_title wcfm_ele',
									'in_table'    => 'yes',
									'desc_class'  => 'wcfm_page_options_desc',
									'value'       => $wcfm_google_map_api,
									'desc'        => sprintf( __( '%1$sAPI Key%2$s is needed to display map on store page', 'wc-multivendor-marketplace' ), '<a target="_blank" href="https://developers.google.com/maps/documentation/javascript/">', '</a>' ),
								),
							)
						)
					);
		...
		if ( ! $installed ) {
			...
			try {
				...
				printf(
					...
					'WCFM Membership',
					$e->getMessage(),
					esc_url( admin_url( 'plugin-install.php?tab=search&s=wc-multivendor-membership' ) )
				);
				exit();
			}
	...
	public function wcfm_setup_commission() {
		...
		<form method="post">
			<table class="form-table">
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_commission',
						array(
							'vendor_commission_for'     => array(
								'label'       => __( 'Commission For', 'wc-multivendor-marketplace' ),
								'type'        => 'select',
								'in_table'    => 'yes',
								'options'     => array(
								...
								'class'       => 'wcfm-select wcfm_ele',
								'label_class' => 'wcfm_title wcfm_ele',
								'value'       => $vendor_commission_for,
							),
							'vendor_commission_mode'    => array(
								...
								'desc'        => __( 'You may setup more commission rules (By Sales Total and Product Price) from setting panel.', 'wc-frontend-manager' ),
							),
							'vendor_commission_percent' => array(
								'label'       => __( 'Commission Percent(%)', 'wc-multivendor-marketplace' ),
								'type'        => 'number',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele commission_mode_field commission_mode_percent commission_mode_percent_fixed',
								'label_class' => 'wcfm_title wcfm_ele commission_mode_field commission_mode_percent commission_mode_percent_fixed',
							...
							'vendor_commission_fixed'   => array(
								'label'       => __( 'Commission Fixed', 'wc-multivendor-marketplace' ) . '(' . get_woocommerce_currency_symbol() . ')',
								'type'        => 'number',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele commission_mode_field commission_mode_fixed commission_mode_percent_fixed',
								'label_class' => 'wcfm_title wcfm_ele commission_mode_field commission_mode_fixed commission_mode_percent_fixed',
							...
							'vendor_get_shipping'       => array(
								'label'       => __( 'Shipping cost goes to vendor?', 'wc-multivendor-marketplace' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_title',
								'value'       => 'yes',
								'dfvalue'     => $vendor_get_shipping,
							),
							'vendor_get_tax'            => array(
								'label'       => __( 'Tax goes to vendor?', 'wc-multivendor-marketplace' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_title',
								'value'       => 'yes',
								'dfvalue'     => $vendor_get_tax,
							),
							'vendor_coupon_deduct'      => array(
								'label'       => __( 'Commission after consider Vendor Coupon?', 'wc-multivendor-marketplace' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_title',
								'value'       => 'yes',
								'dfvalue'     => $vendor_coupon_deduct,
								'hints'       => __( 'Generate vendor commission after deduct Vendor Coupon discounts.', 'wc-multivendor-marketplace' ),
							),
							'admin_coupon_deduct'       => array(
								'label'       => __( 'Commission after consider Admin Coupon?', 'wc-multivendor-marketplace' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_title',
								'value'       => 'yes',
								'dfvalue'     => $admin_coupon_deduct,
								'hints'       => __( 'Generate vendor commission after deduct Admin Coupon discounts.', 'wc-multivendor-marketplace' ),
							),
						)
					)
				);
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_commission_tax',
						array(
							'tax_fields_heading' => array(
								'type'     => 'html',
								'in_table' => 'yes',
								'value'    => '<h2>' . __( 'Commission Tax Settings', 'wc-multivendor-marketplace' ) . '</h2><div class="wcfm_clearfix"></div>',
							),
							'tax_enable'         => array(
								'label'       => __( 'Enable', 'wc-multivendor-marketplace' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								...
								'dfvalue'     => $tax_enable,
								'desc_class'  => 'wcfm_page_options_desc',
								'desc'        => __( 'Enable this to deduct tax from vendor\'s commission.', 'wc-multivendor-marketplace' ),
							),
							'tax_name'           => array(
								'label'       => __( 'Tax Label', 'wc-multivendor-marketplace' ),
								'placeholder' => __( 'Tax', 'wc-multivendor-marketplace' ),
								'type'        => 'text',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele',
								'label_class' => 'wcfm_title',
							...
							'tax_percent'        => array(
								'label'       => __( 'Tax Percent (%)', 'wc-multivendor-marketplace' ),
								'type'        => 'number',
								'in_table'    => 'yes',
	...
	public function wcfm_setup_withdrawal() {
		...
		<form method="post">
			<div>
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_withdrawal',
						array(
							'withdrawal_request_auto_approve' => array(
								'label'       => __( 'Request auto-approve?', 'wc-multivendor-marketplace' ),
								'type'        => 'checkbox',
								'name'        => 'wcfm_withdrawal_options[request_auto_approve]',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_spl_title checkbox_title',
								'value'       => 'yes',
								'dfvalue'     => $request_auto_approve,
								'desc_class'  => 'instructions',
								'desc'        => __( 'Check this to automatically disburse payments to vendors on request, no admin approval required. Auto disbursement only works for auto-payment gateways, e.g. PayPal, Stripe etc. Bank Transfer or other non-autopay mode always requires approval, as these are manual transactions.', 'wc-multivendor-membership' ),
							),
						)
					)
				);
				...
				<table class="form-table">
					...
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_marketplace_settings_fields_withdrawal',
							array(
								'withdrawal_mode'     => array(
									'label'       => __( 'Withdrawal Mode', 'wc-multivendor-marketplace' ),
									'name'        => 'wcfm_withdrawal_options[withdrawal_mode]',
									'type'        => 'select',
									'in_table'    => 'yes',
									'class'       => 'wcfm-select wcfm_ele withdrawal_mode',
									'label_class' => 'wcfm_title withdrawal_mode',
									'options'     => apply_filters(
										'wcfm_withdrawal_modes',
										array(
											'by_manual'   => __( 'Manual Withdrawal', 'wc-multivendor-marketplace' ),
											'by_schedule' => __( 'Periodic Withdrawal', 'wc-multivendor-marketplace' ),
											'by_order_status' => __( 'By Order Status', 'wc-multivendor-marketplace' ),
										)
									),
									'value'       => $withdrawal_mode,
								),

								'withdrawal_auto_withdrawal_status' => array(
									'label'         => __( 'Order Status', 'wc-multivendor-marketplace' ),
									'name'          => 'wcfm_withdrawal_options[auto_withdrawal_status]',
									'type'          => 'select',
									'in_table'      => 'yes',
									'wrapper_class' => 'auto_withdrawal_order_status',
									'class'         => 'wcfm-select wcfm_ele auto_withdrawal_order_status',
									'label_class'   => 'wcfm_title auto_withdrawal_order_status',
									'options'       => $wcfm_marketplace_withdrawal_order_status,
									'value'         => $auto_withdrawal_status,
									'desc_class'    => 'wcfm_page_options_desc auto_withdrawal_order_status',
									'desc'          => __( 'Order status for generate withdrawal request automatically.', 'wc-multivendor-marketplace' ),
								),

								'withdrawal_schedule' => array(
									'label'         => __( 'Schedule', 'wc-multivendor-marketplace' ),
									'name'          => 'wcfm_withdrawal_options[withdrawal_schedule]',
									'type'          => 'select',
									'in_table'      => 'yes',
									'wrapper_class' => 'schedule_withdrawal_threshold_ele',
									'class'         => 'wcfm-select wcfm_ele schedule_withdrawal_threshold_ele',
									'label_class'   => 'wcfm_title schedule_withdrawal_threshold_ele',
									'options'       => apply_filters(
										'wcfm_withdrawal_schedule_periods',
										array(
											'week'    => __( 'Every 7 Days', 'wc-multivendor-marketplace' ),
											'15days'  => __( 'Every 15 Days', 'wc-multivendor-marketplace' ),
											'month'   => __( 'Every 30 Days', 'wc-multivendor-marketplace' ),
											'2months' => __( 'Every 60 Days', 'wc-multivendor-marketplace' ),
											'quarter' => __( 'Every 90 Days', 'wc-multivendor-marketplace' ),
										)
									),
									'value'         => $withdrawal_schedule,
								),
							)
						)
					);
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_withdrawal',
						array(
							'withdrawal_order_status' => array(
								'label'         => __( 'Order Status for Withdraw', 'wc-multivendor-marketplace' ),
								'name'          => 'wcfm_withdrawal_options[order_status]',
								'type'          => 'checklist',
								'wrapper_class' => 'manual_withdrawal_ele',
								'class'         => 'wcfm-checkbox wcfm_ele payment_options',
								'label_class'   => 'wcfm_title wcfm_full_title manual_withdrawal_ele',
								'options'       => $wcfm_marketplace_withdrawal_order_status,
								'value'         => $order_status,
							),
						)
			...
			<table class="form-table">
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_withdrawal_rules',
						array(
							'withdrawal_limit'    => array(
								'label'         => __( 'Minimum Withdraw Limit', 'wc-multivendor-marketplace' ),
								'name'          => 'wcfm_withdrawal_options[withdrawal_limit]',
								'type'          => 'number',
								...
								'desc'          => __( 'Minimum balance required to make a withdraw request. Leave blank to set no minimum limits.', 'wc-multivendor-marketplace' ),
							),
							'withdrawal_thresold' => array(
								'label'         => __( 'Withdraw Threshold', 'wc-multivendor-marketplace' ),
								'name'          => 'wcfm_withdrawal_options[withdrawal_thresold]',
								'type'          => 'number',
								'wrapper_class' => 'withdrawal_threshold_ele',
								'in_table'      => 'yes',
								'class'         => 'wcfm-text wcfm_ele',
								'label_class'   => 'wcfm_title wcfm_ele',
								'desc_class'    => 'wcfm_page_options_desc',
								'value'         => $withdrawal_thresold,
								'attributes'    => array(
									'min'  => '1',
									'step' => '1',
								),
								'desc'          => __( 'Withdraw Threshold Days, (Make order matured to make a withdraw request). Leave empty to inactive this option.', 'wc-multivendor-marketplace' ),
							),
						),
			...
			<div>
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_withdrawal_payment',
						array(
							'withdrawal_payment_methods' => array(
								'label'       => __( 'Withdraw Payment Methods', 'wc-multivendor-membership' ),
								'name'        => 'wcfm_withdrawal_options[payment_methods]',
								'type'        => 'checklist',
								'class'       => 'wcfm-checkbox wcfm_ele payment_options',
								'label_class' => 'wcfm_title wcfm_full_title',
								'options'     => $wcfm_marketplace_withdrwal_payment_methods,
								'value'       => $payment_methods,
							),
							'withdrawal_test_mode'       => array(
								'label'       => __( 'Enable Test Mode', 'wc-multivendor-marketplace' ),
								'type'        => 'checkbox',
								'name'        => 'wcfm_withdrawal_options[test_mode]',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_title checkbox_spl_title',
								'value'       => 'yes',
								'dfvalue'     => $withdrawal_test_mode,
							),
						),
						$wcfm_withdrawal_options
					)
			...
			<?php
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						...
						array(
							'withdrawal_stripe_is_3d_secure' => array(
								'label'       => __( 'Stripe 3D Secure and SCA?', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_3d_secure]',
								'type'        => 'checkbox',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele withdrawal_mode withdrawal_mode_stripe_split',
								'label_class' => 'wcfm_title checkbox_title withdrawal_mode withdrawal_mode_stripe_split',
								'value'       => 'yes',
								'dfvalue'     => $withdrawal_stripe_is_3d_secure,
								'attributes'  => array( 'style' => 'display:block!important;width:auto!important;' ),
								'desc_class'  => 'withdrawal_mode withdrawal_mode_stripe_split wcfm_page_options_desc',
								'desc'        => __( '3D Secure and SCA ready transaction is only supported when both your platform and the connected account (Vendor) are in the same region: both in Europe or both in the U.S.', 'wc-multivendor-marketplace' ),
							),
							'withdrawal_stripe_split_pay_mode' => array(
								'label'       => __( 'Stripe Split Pay Mode', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_split_pay_mode]',
								'type'        => 'select',
								'in_table'    => 'yes',
								'options'     => array(
									'direct_charges'      => __( 'Direct Charges', 'wc-multivendor-marketplace' ),
									'destination_charges' => __( 'Destination Charges', 'wc-multivendor-marketplace' ),
									'transfers_charges'   => __( 'Transfer Charges', 'wc-multivendor-marketplace' ),
								),
								'class'       => 'wcfm-select wcfm_ele withdrawal_mode withdrawal_mode_stripe_split withdrawal_charge_type_ele',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe_split withdrawal_charge_type_ele',
								'value'       => $withdrawal_stripe_split_pay_mode,
								'desc_class'  => 'withdrawal_mode withdrawal_mode_stripe_split wcfm_page_options_desc withdrawal_charge_type_ele',
								'desc'        => __( 'Set your preferred Stripe Split pay mode.', 'wc-multivendor-marketplace' ),
							),
							'withdrawal_paypal_client_id'  => array(
								'label'       => __( 'PayPal Client ID', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[paypal_client_id]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_paypal withdrawal_mode_live',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_paypal withdrawal_mode_live',
								'value'       => $withdrawal_paypal_client_id,
							),
							'withdrawal_paypal_secret_key' => array(
								'label'       => __( 'PayPal Secret Key', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[paypal_secret_key]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_paypal withdrawal_mode_live',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_paypal withdrawal_mode_live',
								'value'       => $withdrawal_paypal_secret_key,
							),
							'withdrawal_stripe_client_id'  => array(
								'label'       => __( 'Stripe Client ID', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_client_id]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_live',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_live',
								'value'       => $withdrawal_stripe_client_id,
							),
							'withdrawal_stripe_published_key' => array(
								'label'       => __( 'Stripe Publish Key', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_published_key]',
								'type'        => 'text',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_live',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_live',
							...
							'withdrawal_stripe_secret_key' => array(
								'label'       => __( 'Stripe Secret Key', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_secret_key]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_live',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_live',
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						...
						array(
							'withdrawal_paypal_test_client_id' => array(
								'label'       => __( 'PayPal Client ID', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[paypal_test_client_id]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_paypal withdrawal_mode_test',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_paypal withdrawal_mode_test',
								'value'       => $withdrawal_paypal_test_client_id,
							),
							'withdrawal_paypal_test_secret_key' => array(
								'label'       => __( 'PayPal Secret Key', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[paypal_test_secret_key]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_paypal withdrawal_mode_test',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_paypal withdrawal_mode_test',
								'value'       => $withdrawal_paypal_test_secret_key,
							),
							'withdrawal_stripe_test_client_id' => array(
								'label'       => __( 'Stripe Client ID', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_test_client_id]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_test',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_test',
								'value'       => $withdrawal_stripe_test_client_id,
							),
							'withdrawal_stripe_test_published_key' => array(
								'label'       => __( 'Stripe Publish Key', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_test_published_key]',
								'type'        => 'text',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_test',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_test',
								'value'       => $withdrawal_stripe_test_published_key,
							),
							'withdrawal_stripe_test_secret_key' => array(
								'label'       => __( 'Stripe Secret Key', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[stripe_test_secret_key]',
								'type'        => 'password',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_test',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_stripe_split withdrawal_mode_test',
								'value'       => $withdrawal_stripe_test_secret_key,
							),
						),
						$wcfm_withdrawal_options
					)
				...
				<?php
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							...
							array(
								'withdrawal_charge_type'   => array(
									'label'       => __( 'Withdrawal Charges', 'wc-multivendor-marketplace' ),
									'name'        => 'wcfm_withdrawal_options[withdrawal_charge_type]',
									'type'        => 'select',
									'in_table'    => 'yes',
									'options'     => array(
										'no'            => __( 'No Charge', 'wc-multivendor-marketplace' ),
									...
									'label_class' => 'wcfm_title wcfm_ele',
									'desc_class'  => 'wcfm_page_options_desc',
									'value'       => $withdrawal_charge_type,
									'desc'        => __( 'Charges applicable for each withdarwal.', 'wc-multivendor-marketplace' ),
								),

								'withdrawal_charge_paypal' => array(
									'label'             => __( 'PayPal Charge', 'wc-multivendor-marketplace' ),
									'type'              => 'multiinput',
									'in_table'          => 'yes',
									'name'              => 'wcfm_withdrawal_options[withdrawal_charge][paypal]',
									...
									'value'             => $withdrawal_charge_paypal,
								...
								'withdrawal_charge_stripe' => array(
									'label'             => __( 'Stripe Charge', 'wc-multivendor-marketplace' ),
									'type'              => 'multiinput',
									'in_table'          => 'yes',
									'name'              => 'wcfm_withdrawal_options[withdrawal_charge][stripe]',
									'wrapper_class'     => 'withdraw_charge_block withdraw_charge_stripe',
									'label_class'       => 'wcfm_title wcfm_ele wcfm_fill_ele withdraw_charge_block withdraw_charge_stripe',
									'value'             => $withdrawal_charge_stripe,
									'custom_attributes' => array( 'limit' => 1 ),
									'options'           => array(
										'percent' => array(
											'label'       => __( 'Percent Charge(%)', 'wc-multivendor-marketplace' ),
								...
								'withdrawal_charge_skrill' => array(
									'label'             => __( 'Skrill Charge', 'wc-multivendor-marketplace' ),
									'type'              => 'multiinput',
									'in_table'          => 'yes',
									'name'              => 'wcfm_withdrawal_options[withdrawal_charge][skrill]',
									'wrapper_class'     => 'withdraw_charge_block withdraw_charge_skrill',
									'label_class'       => 'wcfm_title wcfm_ele wcfm_fill_ele withdraw_charge_block withdraw_charge_skrill',
									'value'             => $withdrawal_charge_skrill,
									'custom_attributes' => array( 'limit' => 1 ),
									'options'           => array(
										'percent' => array(
											'label'       => __( 'Percent Charge(%)', 'wc-multivendor-marketplace' ),
								...
								'withdrawal_charge_bank_transfer' => array(
									'label'             => __( 'Bank Transfer Charge', 'wc-multivendor-marketplace' ),
									'type'              => 'multiinput',
									'in_table'          => 'yes',
									'name'              => 'wcfm_withdrawal_options[withdrawal_charge][bank_transfer]',
									'wrapper_class'     => 'withdraw_charge_block withdraw_charge_bank_transfer',
									'label_class'       => 'wcfm_title wcfm_ele wcfm_fill_ele withdraw_charge_block withdraw_charge_bank_transfer',
									'value'             => $withdrawal_charge_bank_transfer,
									'custom_attributes' => array( 'limit' => 1 ),
									'options'           => array(
										'percent' => array(
											'label'       => __( 'Percent Charge(%)', 'wc-multivendor-marketplace' ),
			...
			<div>	
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_marketplace_settings_fields_reverse_withdrawal',
						array(
							'withdrawal_reverse'       => array(
								'label'       => __( 'Reverse Withdrawal', 'wc-multivendor-marketplace' ),
								'type'        => 'checkbox',
								'name'        => 'wcfm_withdrawal_options[withdrawal_reverse]',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_spl_title checkbox_title',
								'value'       => 'yes',
								'dfvalue'     => $withdrawal_reverse,
								'desc_class'  => 'instructions',
								'desc'        => __( 'Enable this to keep track reverse withdrawals. In case vendor receive full payment (e.g. COD) from customer then they have to reverse-pay admin commission. This is only applicable for auto-withdrawal payment methods.', 'wc-multivendor-marketplace' ),
							),
							'withdrawal_order_payment_methods' => array(
								'label'         => __( 'Reverse or No Withdrawal Payment Methods', 'wc-multivendor-marketplace' ),
								'name'          => 'wcfm_withdrawal_options[disallow_order_payment_methods]',
								'type'          => 'checklist',
								'wrapper_class' => 'reverse_withdrawal_ele',
								'class'         => 'wcfm-checkbox wcfm_ele payment_options reverse_withdrawal_ele',
								'label_class'   => 'wcfm_title wcfm_full_title reverse_withdrawal_ele',
								'options'       => $wcfm_marketplace_disallow_order_payment_methods,
								'value'         => $disallow_order_payment_methods,
								'desc_class'    => 'reverse_withdrawal_ele',
								'desc'          => __( 'Order Payment Methods which are not applicable for vendor withdrawal request. e.g Order payment method COD and vendor receiving that amount directly from customers. So, no more require withdrawal request. You may also enable Reverse Withdrawal to track reverse pending payments for such payment options.', 'wc-multivendor-membership' ),
							),

							'withdrawal_reverse_limit' => array(
								'label'       => __( 'Reverse Withdraw Limit', 'wc-multivendor-marketplace' ),
								'name'        => 'wcfm_withdrawal_options[withdrawal_reverse_limit]',
								'type'        => 'number',
								'class'       => 'wcfm-text wcfm_ele reverse_withdrawal_ele',
								'label_class' => 'wcfm_title checkbox_spl_title wcfm_ele reverse_withdrawal_ele',
								'value'       => $withdrawal_reverse_limit,
								'desc_class'  => 'wcfm_page_options_desc',
								'attributes'  => array(
									'min'  => '1',
									'step' => '1',
								...
								'desc_class'  => 'reverse_withdrawal_ele',
								'desc'        => __( 'Set reverse withdrawal threshold limit, if reverse-pay balance reach this limit then vendor will not allow to withdrawal anymore. Leave empty to inactive this option.', 'wc-multivendor-marketplace' ),
							),
						),
						$wcfm_withdrawal_options
					)
		...
		<form method="post">
			<table class="form-table">
				...
				foreach ( $color_options as $color_option_key => $color_option ) {
					$color_options_array[ $color_option['name'] ] = array(
						'label'       => $color_option['label'],
						'type'        => 'colorpicker',
						'in_table'    => 'yes',
						'class'       => 'wcfm-text wcfm_ele colorpicker',
						'label_class' => 'wcfm_title wcfm_ele',
						'value'       => ( isset( $wcfm_options[ $color_option['name'] ] ) ) ? $wcfm_options[ $color_option['name'] ] : $color_option['default'],
					);
				}
	...
	public function wcfm_setup_capability() {
		...
		<form method="post">
			<table class="form-table">
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_settings_fields_vendor_access',
						array(
							'vnd_wpadmin' => array(
								'label'       => __( 'Backend Access', 'wc-frontend-manager' ) . ' (wp-admin)',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_settings_fields_vendor_products',
						array(
							'submit_products'    => array(
								'label'       => __( 'Submit Products', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
							...
							'publish_products'   => array(
								'label'       => __( 'Publish Products', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $publish_products,
							),
							'edit_live_products' => array(
								'label'       => __( 'Edit Live Products', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $edit_live_products,
							),
							'delete_products'    => array(
								'label'       => __( 'Delete Products', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $delete_products,
							),
						)
					)
				);
				...
				if ( wcfm_is_booking() ) {
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_settings_fields_vendor_booking',
							array(
								'manage_booking' => array(
									'label'       => __( 'Manage Bookings', 'wc-frontend-manager' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox wcfm_ele',
									'value'       => 'yes',
				...
				if ( wcfm_is_subscription() || wcfm_is_xa_subscription() ) {
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_settings_fields_vendor_subscription',
							array(
								'manage_subscription' => array(
									'label'       => __( 'Manage Subscriptions', 'wc-frontend-manager' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox wcfm_ele',
									'value'       => 'yes',
				...
				if ( WCFM_Dependencies::wcfm_wp_job_manager_plugin_active_check() ) {
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_settings_fields_vendor_listings',
							array(
								'associate_listings' => array(
									'label'       => __( 'Listings', 'wc-frontend-manager' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox wcfm_ele',
									'value'       => 'yes',
									'label_class' => 'wcfm_title checkbox_title',
									'desc'        => __( 'by WP Job Manager.', 'wc-frontend-manager' ),
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_settings_fields_vendor_orders',
						array(
							'view_orders'         => array(
								'label'       => __( 'View Orders', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
							...
							'order_status_update' => array(
								'label'       => __( 'Status Update', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $order_status_update,
							),
						)
					)
				);
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						'wcfm_settings_fields_vendor_reports',
						array(
							'view_reports' => array(
								'label'       => __( 'View Reports', 'wc-frontend-manager' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox wcfm_ele',
								'value'       => 'yes',
	...
	public function wcfm_setup_dashboard_save() {
		...
		if ( ! $dashboard_full_view_disabled ) {
		...
		if ( ! $dashboard_theme_header_disabled ) {
	...
	public function wcfm_setup_marketplace_save() {
		...
		if ( ! $enable_marketplace_shipping ) {
			$enable_marketplace_shipping = 'yes';
		} else {
			$enable_marketplace_shipping = 'no';
		}

		if ( ! $enable_marketplace_shipping_by_weight ) {
	...
	public function wcfm_setup_style_save() {
		...
		foreach ( $color_options as $color_option_key => $color_option ) {
			...
			if ( $color_value ) {
				$options[ $color_option['name'] ] = $color_value;
			} else {
	...
	public function wcfm_setup_capability_save() {
		...
		if ( ! $vnd_wpadmin ) {
			$wcfm_capability_options['vnd_wpadmin'] = 'no';
		} else {
			$wcfm_capability_options['vnd_wpadmin'] = 'yes';
		}

		if ( ! $submit_products ) {
			$wcfm_capability_options['submit_products'] = 'no';
		} else {
			$wcfm_capability_options['submit_products'] = 'yes';
		}

		if ( ! $publish_products ) {
			$wcfm_capability_options['publish_products'] = 'no';
		} else {
			$wcfm_capability_options['publish_products'] = 'yes';
		}

		if ( ! $edit_live_products ) {
			$wcfm_capability_options['edit_live_products'] = 'no';
		} else {
			$wcfm_capability_options['edit_live_products'] = 'yes';
		}

		if ( ! $delete_products ) {
			$wcfm_capability_options['delete_products'] = 'no';
		} else {
			$wcfm_capability_options['delete_products'] = 'yes';
		}

		if ( ! $manage_booking ) {
			$wcfm_capability_options['manage_booking'] = 'no';
		} else {
			$wcfm_capability_options['manage_booking'] = 'yes';
		}

		if ( ! $manage_subscription ) {
			$wcfm_capability_options['manage_subscription'] = 'no';
		} else {
			$wcfm_capability_options['manage_subscription'] = 'yes';
		}

		if ( ! $associate_listings ) {
			$wcfm_capability_options['associate_listings'] = 'no';
		} else {
			$wcfm_capability_options['associate_listings'] = 'yes';
		}

		if ( ! $view_orders ) {
			$wcfm_capability_options['view_orders'] = 'no';
		} else {
			$wcfm_capability_options['view_orders'] = 'yes';
		}

		if ( ! $view_reports ) {
			$wcfm_capability_options['view_reports'] = 'no';
		} else {
