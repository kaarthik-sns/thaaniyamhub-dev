...
class WCFM_Dashboard_Setup {
	...
	public function wcfm_dashboard_setup() {
		...
		if ( ! $is_marketplace ) {
			...
			unset( $default_steps['withdrawal'] );
			unset( $default_steps['registration'] );
		} elseif ( WCFM_Dependencies::wcfmvm_plugin_active_check() ) {
			unset( $default_steps['registration'] );
		}
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field(
					apply_filters(
						...
						array(
							...
							'responsive_float_menu_disabled' => array(
								'label'       => __( 'Disable Responsive Float Menu', 'wc-frontend-manager' ),
								'name'        => 'responsive_float_menu_disabled',
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'value'       => 'yes',
								'label_class' => 'wcfm_title checkbox_title',
								'dfvalue'     => $is_responsive_float_menu_disabled,
							),
						...
						apply_filters(
							...
							array(
								'vendor_store_url'        => array(
									'label'       => __( 'Vendor Store URL', 'wc-multivendor-marketplace' ),
									'type'        => 'text',
								...
								'vendor_sold_by_position' => array(
									...
									'in_table'    => 'yes',
									'options'     => array(
										'bellow_price' => __( 'Bellow Price', 'wc-multivendor-marketplace' ),
								...
								'product_mulivendor'      => array(
									'label'       => __( 'Product Mulivendor', 'wc-multivendor-marketplace' ),
									'type'        => 'checkboxoffon',
									'in_table'    => 'yes',
									'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
									'label_class' => 'wcfm_title checkbox_title',
									'value'       => 'yes',
									'dfvalue'     => $product_mulivendor,
									'desc_class'  => 'wcfm_page_options_desc',
									'desc'        => __( 'Enable this to allow vendors to sell other vendor products, single product multiple seller.', 'wc-multivendor-marketplace' ),
								),
					...
					apply_filters(
						...
						array(
							...
							'vendor_coupon_deduct'      => array(
								'label'       => __( 'Commission after deduct discounts?', 'wc-multivendor-marketplace' ),
								'type'        => 'checkboxoffon',
								'in_table'    => 'yes',
								'class'       => 'wcfm-checkbox input-checkbox wcfm_ele',
								'label_class' => 'wcfm_title checkbox_title',
								...
								'hints'       => __( 'Generate vendor commission after deduct coupon or other discounts.', 'wc-multivendor-marketplace' ),
							),
						)
					)
				);
		...
		<form method="post">
					...
					apply_filters(
						...
						array(
							...
							'withdrawal_stripe_client_id'  => array(
								...
								'type'        => 'text',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_live',
							...
							'withdrawal_stripe_test_client_id' => array(
								...
								'type'        => 'text',
								'in_table'    => 'yes',
								'class'       => 'wcfm-text wcfm_ele withdrawal_mode withdrawal_mode_stripe withdrawal_mode_test',
								'label_class' => 'wcfm_title withdrawal_mode withdrawal_mode_stripe withdrawal_mode_test',
				...
				apply_filters(
					...
					array(
						'withdrawal_order_status'          => array(
							'label'       => __( 'Order Status for Withdraw', 'wc-multivendor-membership' ),
						...
						'withdrawal_order_payment_methods' => array(
							'label'       => __( 'Disallow Order Payment Mothods for Withdraw', 'wc-multivendor-membership' ),
							...
							'desc'        => __( 'Order Payment Mothods which are not applicable for vendor withdrawal request. e.g Order payment method COD and vendor receiving that amount directly from customers.', 'wc-multivendor-membership' ),
						),
					)
				)
			);
			...
			<table class="form-table">	
				<?php
					$WCFM->wcfm_fields->wcfm_generate_form_field(
						apply_filters(
							'wcfm_marketplace_settings_fields_withdrawal_limits',
							array(
	...
	public function wcfm_setup_dashboard_save() {
		...
		if ( ! $responsive_float_menu_disabled ) {
			$options['responsive_float_menu_disabled'] = 'no';
		} else {
