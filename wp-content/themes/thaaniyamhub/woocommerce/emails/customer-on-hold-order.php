<?php
/**
 * Customer On-Hold Order Email — Thaaniyam Hub
 * Override: yourtheme/woocommerce/emails/customer-on-hold-order.php
 * @version 10.4.0
 */
...
$subheadline = 'Hi ' . $first_name . ', we\'re awaiting payment confirmation for your order.';
...
?>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
              <tr>
                ...
                <td width="33%" align="center" style="padding:18px 10px;vertical-align:top;">
                  <div style="font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#8BA888;font-family:Arial,Helvetica,sans-serif;margin-bottom:5px;">Total</div>
        ...
        <tr>
          <td class="email-section-td" style="background-color:#ffffff;border-left:1px solid #E0EBD8;border-right:1px solid #E0EBD8;border-top:1px solid #F0F5EC;padding:24px 32px;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td style="background-color:#FFF3CD;border:1px solid #FFEAA7;border-radius:20px;padding:5px 14px;" bgcolor="#FFF3CD"><span style="font-size:12px;font-family:Arial,Helvetica,sans-serif;font-weight:700;color:#856404;">On Hold</span></td></tr></table>
          </td>
        </tr>
